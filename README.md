...
* 对抗
  * [Improving Adversarial Transferability via Model Alignment](https://arxiv.org/abs/2311.18495)<br>:star:[code](https://github.com/averyma/model-alignment)
  ...
  * [Data Poisoning Quantization Backdoor Attack](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11142.pdf)
  * [Flatness-aware Sequential Learning Generates Resilient Backdoors](https://www.arxiv.org/abs/2407.14738)
  * [WBP: Training-time Backdoor Attacks through Hardware-based Weight Bit Poisoning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08195.pdf)<br>:star:[code](https://github.com/casrl/WBP)
  * [Cocktail Universal Adversarial Attack on Deep Neural Networks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08267.pdf)
  * [TrojVLM: Backdoor Attack Against Vision Language Models](https://arxiv.org/abs/2409.19232)
  * [CatchBackdoor: Backdoor Detection via Critical Trojan Neural Path Fuzzing](https://arxiv.org/abs/2112.13064)
  ...
  * [Exploring Vulnerabilities in Spiking Neural Networks: Direct Adversarial Attacks on Raw Event Data](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09164.pdf)
  ...
  * [DIFFender: Diffusion-Based Adversarial Defense against Patch Attacks](https://arxiv.org/abs/2306.09124)<br>:star:[code](https://github.com/kkkcx/DIFFender)
* 持续学习
  ...
  * [Semantic Residual Prompts for Continual Learning](https://arxiv.org/abs/2403.06870)<br>:star:[code](https://github.com/aimagelab/mammoth)
  * [Pick-a-back: Selective Device-to-Device Knowledge Transfer in Federated Continual Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07822.pdf)<br>:star:[code](https://github.com/jinyi-yoon/Pick-a-back.git)
  ...
  * [PromptFusion: Decoupling Stability and Plasticity for Continual Learning](https://arxiv.org/abs/2303.07223)<br>:star:[code](https://github.com/haoranchen/promptfusion)
  * [Information Bottleneck Based Data Correction in Continual Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11862.pdf)
...
* 主动学习
  ...
  * [Exploring Active Learning in Meta-Learning: Enhancing Context Set Labeling](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12574.pdf)
* 强化学习
  ...
  * [Reinforcement Learning via Auxillary Task Distillation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10541.pdf)
  * [Reinforcement Learning Friendly Vision-Language Model for Minecraft](https://arxiv.org/abs/2303.10571)<br>:star:[code](https://github.com/PKU-RL/CLIP4MC)
...
* 联邦学习
  ...
  * [FedHide: Federated Learning by Hiding in the Neighbors](https://arxiv.org/abs/2409.07808)
  * [FedHARM: Harmonizing Model Architectural Diversity in Federated Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07971.pdf)<br>:star:[code](https://github.com/Kastellos/FedHARM)
  * [FedTSA: A Cluster-based Two-Stage Aggregation Method for Model-heterogeneous Federated Learning](https://arxiv.org/abs/2407.05098)
  * [Unlocking the Potential of Federated Learning: The Symphony of Dataset Distillation via Deep Generative Latents](https://arxiv.org/abs/2312.01537)<br>:star:[code](https://github.com/FedDG23/FedDG-main.git)
  * [PFedEdit: Personalized Federated Learning via Automated Model Editing](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10133.pdf)<br>:star:[code](https://github.com/Haolin-Yuan/PFedEdit)
  * [Overcome Modal Bias in Multi-modal Federated Learning via Balanced Modality Selection](https://arxiv.org/abs/2401.00403)
...
* 对比学习
  ...
  * [Adaptive Multi-head Contrastive Learning](https://arxiv.org/abs/2310.05615)
  ...
  * [Learning the Unlearned: Mitigating Feature Suppression in Contrastive Learning](https://arxiv.org/abs/2402.11816)<br>:star:[code](https://github.com/MajorDavidZhang/MCL.git)
* 类增量
  ...
  * [PILoRA: Prototype Guided Incremental LoRA for Federated Class-Incremental Learning](https://arxiv.org/abs/2401.02094)<br>:star:[code](https://github.com/Ghy0501/PILoRA)
  * [CLOSER: Towards Better Representation Learning for Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2410.05627)<br>:star:[code](https://github.com/JungHunOh/CLOSER_ECCV2024)
  * [Non-Exemplar Domain Incremental Learning via Cross-Domain Concept Integration](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06534.pdf)<br>:star:[code](https://github.com/qwangcv/PINA)
  * [On the Approximation Risk of Few-Shot Class-Incremental Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06766.pdf)<br>:star:[code](https://github.com/xwangrs/Approximation_FSCIL-ECCV2024.git)
  * [iNeMo: Incremental Neural Mesh Models for Robust Class-Incremental Learning](https://arxiv.org/abs/2407.09271)<br>:star:[code](https://github.com/Fischer-Tom/iNeMo)
...
* 多任务学习
  * [Learning Representation for Multitask Learning through Self-Supervised Auxiliary Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10369.pdf)
  * 多标签学习
    ...
    * [Dual-Decoupling Learning and Metric-Adaptive Thresholding for Semi-Supervised Multi-Label Learning](https://arxiv.org/abs/2407.18624)
* 多实例学习
  * [cDP-MIL: Robust Multiple Instance Learning via Cascaded Dirichlet Process](https://arxiv.org/abs/2407.11448)<br>:star:[code](https://github.com/HKU-MedAI/cDPMIL)
* 多模态学习
  ...
  * [Object-Oriented Anchoring and Modal Alignment in Multimodal Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06669.pdf)
...
* DG
  ...
  * [Local and Global Flatness for Federated Domain Generalization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10888.pdf)<br>:star:[code](https://github.com/cnyanhao/FedLGF)
  ...
  * [Disentangling Masked Autoencoders for Unsupervised Domain Generalization](https://arxiv.org/abs/2407.07544)<br>:star:[code](https://github.com/rookiehb/DisMAE)
* DA
  ...
  * [Open-set Domain Adaptation via Joint Error based Multi-class Positive and Unlabeled Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09228.pdf)
  * [Robust Nearest Neighbors for Source-Free Domain Adaptation under Class Distribution Shift](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09049.pdf)<br>:star:[code](https://github.com/CyberAgentAILab/Robust_Nearest_Neighbors_SFDA-CDS)
  * [HVCLIP: High-dimensional Vector in CLIP for Unsupervised Domain Adaptation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08284.pdf)
  * [Hierarchical Unsupervised Relation Distillation for Source Free Domain Adaptation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06726.pdf)
  ...
  * [Get Your Embedding Space in Order: Domain-Adaptive Regression for Forest Monitoring](https://arxiv.org/abs/2405.00514)<br>:house:[project](dgominski.github.io/drift/)
  * [CoDA: Instructive Chain-of-Domain Adaptation with Severity-Aware Visual Prompt Tuning](https://arxiv.org/abs/2403.17369)<br>:star:[code](https://github.com/Cuzyoung/CoDA)
  * [COD: Learning Conditional Invariant Representation for Domain Adaptation Regression](https://arxiv.org/abs/2408.06638v1)
  * [Plug and Play: A Representation Enhanced Domain Adapter for Collaborative Perception](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10564.pdf)<br>:star:[code](https://github.com/luotianyou349/PnPDA)
...
* 零样本
  ...
  * [MRSP: Learn Multi-Representations of Single Primitive for Compositional Zero-Shot Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08153.pdf)

<a name="21"/>

## 21.Vision-Language(视觉语言)
* [Sapiens: Foundation for Human Vision Models](https://arxiv.org/abs/2408.12569)
* [Conceptual Codebook Learning for Vision-Language Models](https://arxiv.org/abs/2407.02350)
...
* [Boosting Transferability in Vision-Language Attacks via Diversification along the Intersection Region of Adversarial Trajectory](https://arxiv.org/abs/2403.12445)<br>:star:[code](https://github.com/SensenGao/VLPTransferAttack)
...
* [Unveiling Typographic Deceptions: Insights of the Typographic Vulnerability in Large Vision-Language Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07650.pdf)<br>:star:[code](https://github.com/ChaduCheng/TypoDecep)
...
* [Deciphering the Role of Representation Disentanglement: Investigating Compositional Generalization in CLIP Models](http://arxiv.org/abs/2407.05897v1)<br>:star:[code](https://github.com/abbasiReza/CLIP-COoD)
...
* [Cascade Prompt Learning for Visual-Language Model Adaptation](https://arxiv.org/abs/2409.17805)<br>:star:[code](https://github.com/megvii-research/CasPL)
...
* [An Image is Worth 1/2 Tokens After Layer 2: Plug-and-Play Inference Acceleration for Large Vision-Language Models](https://arxiv.org/abs/2403.06764)<br>:star:[code](https://github.com/pkunlp-icler/FastV)
* [Improving Vision and Language Concepts Understanding with Multimodal Counterfactual Samples](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08703.pdf)<br>:star:[code](https://github.com/laichengen/COMO)
...
* [The First to Know: How Token Distributions Reveal Hidden Knowledge in Large Vision-Language Models?](https://arxiv.org/abs/2403.09037)<br>:star:[code](https://github.com/Qinyu-Allen-Zhao/LVLM-LP)
* [Safe-CLIP: Removing NSFW Concepts from Vision-and-Language Models](https://arxiv.org/abs/2311.16254)<br>:star:[code](https://github.com/aimagelab/safe-clip)
* [Adapt without Forgetting: Distill Proximity from Dual Teachers in Vision-Language Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07052.pdf)<br>:star:[code](https://github.com/myz-ah/AwoForget)
* [Exploiting Semantic Reconstruction to Mitigate Hallucinations in Vision-Language Models](https://arxiv.org/abs/2403.16167)
* [uCAP: An Unsupervised Prompting Method for Vision-Language Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09508.pdf)
* [Training A Small Emotional Vision Language Model for Visual Art Comprehension](https://arxiv.org/abs/2403.11150)<br>:star:[code](https://github.com/BetterZH/SEVLM-code)
* [Understanding Multi-compositional learning in Vision and Language models via Category Theory](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06472.pdf)<br>:star:[code](https://github.com/SPChytas/CatCom)
...
* VLN 
  * [PRET: Planning with Directed Fidelity Trajectory for Vision and Language Navigation](https://arxiv.org/abs/2407.11487)<br>:star:[code](https://github.com/iSEE-Laboratory/VLN-PRET)
  ...
  * [Frontier-enhanced Topological Memory with Improved Exploration Awareness for Embodied Visual Navigation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08905.pdf)<br>:star:[code](https://github.com/IRMVLab/FTM-nav)
* LLM
  ...
  * [SPHINX: A Mixer of Weights, Visual Embeddings and Image Scales for Multi-modal Large Language Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07894.pdf)<br>:star:[code](https://github.com/Alpha-VLLM/LLaMA2-Accessory)
  * [ST-LLM: Large Language Models Are Effective Temporal Learners](https://arxiv.org/abs/2404.00308)<br>:star:[code](https://github.com/TencentARC/ST-LLM)
  * [Dissecting Dissonance: Benchmarking Large Multimodal Models Against Self-Contradictory Instructions](https://arxiv.org/abs/2408.01091)<br>:house:[project](https://selfcontradiction.github.io/)
  * [How Many Unicorns Are in This Image? A Safety Evaluation Benchmark for Vision LLMs](https://arxiv.org/abs/2311.16101)<br>:star:[code](https://github.com/UCSC-VLAA/vllm-safety-benchmark)
  * [BenchLMM: Benchmarking Cross-style Visual Capability of Large Multimodal Models](https://arxiv.org/abs/2312.02896)<br>:star:[code](https://github.com/AIFEG/BenchLMM)
  * [MoAI: Mixture of All Intelligence for Large Language and Vision Models](https://arxiv.org/abs/2403.07508)<br>:star:[code](https://github.com/ByungKwanLee/MoAI)<br>🤗[huggingface](https://huggingface.co/papers/2403.07508) 
  * [Paying More Attention to Images: A Training-Free Method for Alleviating Hallucination in LVLMs](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10933.pdf)<br>:house:[project](https://lalbj.github.io/projects/PAI/)
  * [LLaVA-UHD: an LMM Perceiving any Aspect Ratio and High-Resolution Images](https://arxiv.org/abs/2403.11703)<br>:star:[code](https://github.com/thunlp/LLaVA-UHD)
  ...
  * [Images are Achilles' Heel of Alignment: Exploiting Visual Vulnerabilities for Jailbreaking Multimodal Large Language Models](https://arxiv.org/abs/2403.09792)<br>:star:[code](https://github.com/AoiDragon/HADES)
...
* 视觉语言理解
  ...
  * [GRiT: A Generative Region-to-text Transformer for Object Understanding](https://arxiv.org/abs/2212.00280)<br>:star:[code](https://github.com/JialianW/GRiT)
  
<a name="20"/>

## 20.Scene 
* [LatentEditor: Text Driven Local Editing of 3D Scenes](https://arxiv.org/abs/2312.09313)<br>:house:[project](https://latenteditor.github.io/)
* [RoomTex: Texturing Compositional Indoor Scenes via Iterative Inpainting](https://arxiv.org/abs/2406.02461)<br>:star:[code](https://github.com/qwang666/RoomTex-)室内场景
...
* [Compact 3D Scene Representation via Self-Organizing Gaussian Grids](https://arxiv.org/abs/2312.13299)<br>:star:[code](https://github.com/fraunhoferhhi/Self-Organizing-Gaussians)
* [CARFF: Conditional Auto-encoded Radiance Field for 3D Scene Forecasting](https://arxiv.org/abs/2401.18075)<br>:house:[project](http://www.carff.website/)
* 场景合成
  ...
  * [BeyondScene: Higher-Resolution Human-Centric Scene Generation With Pretrained Diffusion](https://arxiv.org/abs/2404.04544)<br>:house:[project](https://janeyeon.github.io/beyond-scene/)
  ...
  * [WoVoGen: World Volume-aware Diffusion for Controllable Multi-camera Driving Scene Generation](https://arxiv.org/abs/2312.02934)<br>:star:[code](https://github.com/fudan-zvg/WoVoGen)驾驶场景生成
* 场景理解
  ...
  * [R3DS: Reality-linked 3D Scenes for Panoramic Scene Understanding](https://arxiv.org/abs/2403.12301)<br>:house:[project](https://3dlg-hcvc.github.io/r3ds/)
  ...
  * [MTMamba: Enhancing Multi-Task Dense Scene Understanding by Mamba-Based Decoders](https://arxiv.org/abs/2407.02228)<br>:star:[code](https://github.com/EnVision-Research/MTMamba)密集场景理解
* 语义场景完
  ...
  * [Easing 3D Pattern Reasoning with Side-view Features for Semantic Scene Completion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08816.pdf)
...
* 场景图生成
  ...
  * [Semantic Diversity-aware Prototype-based Learning for Unbiased Scene Graph Generation](http://arxiv.org/abs/2407.15396v1)<br>:star:[code](https://github.com/JeonJaeHyeong/DPL.git)
  ...
  * [A Fair Ranking and New Model for Panoptic Scene Graph Generation](https://arxiv.org/abs/2407.09216)<br>:house:[project](https://lorjul.github.io/fair-psgg/)
  * [Multi-Granularity Sparse Relationship Matrix Prediction Network for End-to-End Scene Graph Generation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10738.pdf)<br>:star:[code](https://github.com/wanglei0618/Mg-RMPN)
  * [Towards Scene Graph Anticipation](https://arxiv.org/abs/2403.04899)<br>:star:[code](https://github.com/rohithpeddi/SceneSayer)
...
* [Geospecific View Generation - Geometry-Context Aware High-resolution Ground View Inference from Satellite Views](https://arxiv.org/abs/2407.08061)<br>:house:[project](https://gdaosu.github.io/geocontext/)卫星视图
* [Probabilistic Image-Driven Traffic Modeling via Remote Sensing](https://arxiv.org/abs/2403.05521)
* [UAV First-Person Viewers Are Radiance Field Learners](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07802.pdf)<br>:house:[project](https://fpv-nerf.github.io/)
...
* [Multi-scale Cross Distillation for Object Detection in Aerial Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06619.pdf)
* [LHRS-Bot: Empowering Remote Sensing with VGI-Enhanced Large Multimodal Language Model](https://arxiv.org/abs/2402.02544)<br>:star:[code](https://github.com/NJU-LHRS/LHRS-Bot)
* [PDT Uav Target Detection Dataset for Pests and Diseases Tree](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09702.pdf)<br>:star:[code](https://github.com/RuiXing123/PDT_CWC_YOLO-DP)
* [Contrastive ground-level image and remote sensing pre-training improves representation learning for natural world imagery](https://arxiv.org/abs/2409.19439)<br>🤗[huggingface](https://huggingface.co/datasets/andyvhuynh/NatureMultiView)遥感
* [Toward Open Vocabulary Aerial Object Detection with CLIP-Activated Student-Teacher Learning](https://arxiv.org/abs/2311.11646)<br>:star:[code](https://github.com/lizzy8587/CastDet)

<a name="18"/>

## 18.Automated Driving(自动驾驶)
* [Online Vectorized HD Map Construction using Geometry](https://arxiv.org/abs/2312.03341)<br>:star:[code](https://github.com/cnzzx/GeMap)
* [MUSES: The Multi-Sensor Semantic Perception Dataset for Driving under Uncertainty](https://arxiv.org/abs/2401.12761)<br>:star:[code](https://github.com/timbroed/MUSES)
* [HENet: Hybrid Encoding for End-to-end Multi-task 3D Perception from Multi-view Cameras](https://arxiv.org/abs/2404.02517)<br>:star:[code](https://github.com/VDIGPKU/HENet)
...
* [Generative End-to-End Autonomous Driving](https://arxiv.org/abs/2402.11502)<br>:star:[code](https://github.com/wzzheng/GenAD)
* [CARB-Net: Camera-Assisted Radar-Based Network for Vulnerable Road User Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08101.pdf)<br>:star:[code](https://github.com/weiyulee/RadVRU)驾驶
* [FipTR: A Simple yet Effective Transformer Framework for Future Instance Prediction in Autonomous Driving](https://arxiv.org/abs/2404.12867)<br>:star:[code](https://github.com/TabGuigui/FipTR)
* [Mask2Map: Vectorized HD Map Construction Using Bird's Eye View Segmentation Masks](https://arxiv.org/abs/2407.13517)<br>:star:[code](https://github.com/SehwanChoi0307/Mask2Map)驾驶
...
* [LingoQA: Video Question Answering for Autonomous Driving](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09911.pdf)<br>:star:[code](https://github.com/wayveai/LingoQA)
* [PreSight: Enhancing Autonomous Vehicle Perception with City-Scale NeRF Priors](https://arxiv.org/abs/2403.09079)<br>:star:[code](https://github.com/yuantianyuan01/PreSight)
* [VQA-Diff: Exploiting VQA and Diffusion for Zero-Shot Image-to-3D Vehicle Asset Generation in Autonomous Driving](https://arxiv.org/abs/2407.06516)
* [TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Autonomous Driving](https://arxiv.org/abs/2404.02410)
* [Learning to Drive via Asymmetric Self-Play](https://arxiv.org/abs/2409.18218)<br>:house:[project](https://waabi.ai/selfplay/)
* [Embodied Understanding of Driving Scenarios](https://arxiv.org/abs/2403.04593)<br>:star:[code](https://github.com/OpenDriveLab/ELM)
* [Early Anticipation of Driving Maneuvers](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08862.pdf)<br>:house:[project](https://cvit.iiit.ac.in/research/projects/cvit-projects/daad)
* [RealGen: Retrieval Augmented Generation for Controllable Traffic Scenarios](https://arxiv.org/abs/2312.13303)<br>:house:[project](https://realgen.github.io)
* [Event-Aided Time-To-Collision Estimation for Autonomous Driving](https://arxiv.org/abs/2407.07324)<br>:house:[project](https://nail-hnu.github.io/EventAidedTTC/)
...
* [DriveDreamer: Towards Real-world-driven World Models for Autonomous Driving](https://arxiv.org/abs/2309.09777)<br>:house:[project](https://drivedreamer.github.io/)
...
* [Beyond the Data Imbalance: Employing the Heterogeneous Datasets for Vehicle Maneuver Prediction](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07256.pdf)<br>:star:[code](https://github.com/KAIST-VDCLab/VDC-Trajectory-Dataset)
* 轨迹预测
  ...
  * [CoMusion: Towards Consistent Stochastic Human Motion Prediction via Motion Diffusion](https://arxiv.org/abs/2305.12554)人体运动预测
  ...
  * [MART: MultiscAle Relational Transformer Networks for Multi-agent Trajectory Prediction](https://arxiv.org/abs/2407.21635)<br>:star:[code](https://github.com/gist-ailab/MART)
...
* 占据预测
  ...
  * [CVT-Occ: Cost Volume Temporal Fusion for 3D Occupancy Prediction](https://arxiv.org/abs/2409.13430)<br>:star:[code](https://github.com/Tsinghua-MARS-Lab/CVT-Occ)
...
* 车辆监控
  * [TrafficNight : An Aerial Multimodal Benchmark For Nighttime Vehicle Surveillance](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08163.pdf)
...
* [Training-free Video Temporal Grounding using Large-scale Pre-trained Models](http://arxiv.org/abs/2408.16219v1)<br>:star:[code](https://github.com/minghangz/TFVTG)
...
* [E3M: Zero-Shot Spatio-Temporal Video Grounding with Expectation-Maximization Multimodal Modulation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11011.pdf)<br>:star:[code](https://github.com/baopj/E3M)
...
* [DEVIAS: Learning Disentangled Video Representations of Action and Scene](https://arxiv.org/abs/2312.00826)<br>:star:[code](https://github.com/KHU-VLL/DEVIAS)
* [VideoStudio: Generating Consistent-Content and Multi-Scene Videos](https://arxiv.org/abs/2401.01256)<br>:house:[project](https://vidstudio.github.io/)
* VAD
  ...
  * [Follow the Rules: Reasoning for Video Anomaly Detection with Large Language Models](https://arxiv.org/abs/2407.10299)<br>:star:[code](https://github.com/Yuchen413/AnomalyRuler)
  * [FedVAD: Enhancing Federated Video Anomaly Detection with GPT-Driven Semantic Distillation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06981.pdf)<br>:star:[code](https://github.com/Eurekaer/FedVAD)
...
* 视频摘要
  * [Contextual Correspondence Matters: Bidirectional Graph Matching for Video Summarization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11870.pdf)
* 视频理解
  ...
  * [Towards Neuro-Symbolic Video Understanding](https://arxiv.org/abs/2403.11021)<br>:star:[code](https://github.com/UTAustin-SwarmLab/Neuro-Symbolic-Video-Search-Temporal-Logic)
  ...
  * [VideoAgent: Long-form Video Understanding with Large Language Model as Agent](https://arxiv.org/abs/2403.10517)<br>🤗[huggingface](https://huggingface.co/papers/2403.10517)
  * [InternVideo2: Scaling Foundation Models for Multimodal Video Understanding](https://arxiv.org/abs/2403.15377)<br>:star:[code](https://github.com/OpenGVLab/InternVideo/tree/main/InternVideo2/)
...
* 视频帧插值
  ...
  * [TimeLens-XL: Real-time Event-based Video Frame Interpolation with Large Motion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11208.pdf)<br>:house:[project](https://openimaginglab.github.io/TimeLens-XL/)
* 视频类增量
...
* [Adaptive Compressed Sensing with Diffusion-Based Posterior Sampling](http://arxiv.org/abs/2407.08256v1)<br>:star:[code](https://github.com/noamelata/AdaSense)
...
* [Knowledge-enhanced Visual-Language Pretraining for Computational Pathology](https://arxiv.org/abs/2404.09942)<br>:star:[code](https://github.com/MAGIC-AI4Med/KEP)
...
* [Bridging the Pathology Domain Gap: Efficiently Adapting CLIP for Pathology Image Analysis with Limited Labeled Data](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08099.pdf)病理学图像分析
* [Unified Medical Image Pre-training in Language-Guided Common Semantic Space](https://arxiv.org/abs/2311.14851)
* [Rethinking Deep Unrolled Model for Accelerated MRI Reconstruction](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09565.pdf)<br>:star:[code](https://github.com/hellopipu/PromptMR-plus)
* [Style-Extracting Diffusion Models for Semi-Supervised Histopathology Segmentation](https://arxiv.org/abs/2403.14429)<br>:star:[code](https://github.com/OettlM/STEDM)半监督组织病理学分割
* 组织病理学图像分类
...
* 切片图像分类
  ...
  * [Norma: A Noise Robust Memory-Augmented Framework for Whole Slide Image Classification](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06825.pdf)<br>:star:[code](https://github.com/weiaicunzai/Norma)
  * [Attention-Challenging Multiple Instance Learning for Whole Slide Image Classification](https://arxiv.org/abs/2311.07125)<br>:star:[code](https://github.com/dazhangyu123/ACMIL)
* 医学图像分割
  ...
  * [The Devil is in the Statistics: Mitigating and Exploiting Statistics Difference for Generalizable Semi-supervised Medical Image Segmentation](https://arxiv.org/abs/2407.11356)<br>:star:[code](https://github.com/qiumuyang/SIAB)
  ...
  * [Gradient-Aware for Class-Imbalanced Semi-supervised Medical Image Segmentation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07246.pdf)<br>:star:[code](https://github.com/cicailalala/GALoss)
  * [AnatoMask: Enhancing Medical Image Segmentation with Reconstruction-guided Self-masking](https://www.arxiv.org/abs/2407.06468)<br>:star:[code](https://github.com/ricklisz/AnatoMask)
...
* 医学图像配准
  ...
  * [NePhi: Neural Deformation Fields for Approximately Diffeomorphic Medical Image Registration](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12148.pdf)<br>:star:[code](https://github.com/uncbiag/NePhi)
...
* 医学报告生成
  ...
  * [MedRAT: Unpaired Medical Report Generation via Auxiliary Tasks](https://arxiv.org/abs/2407.03919v2)<br>:star:[code](https://github.com/eladhi/MedRAT)
* X 光片
...
* CT 
  * [GenerateCT: Text-Conditional Generation of 3D Chest CT Volumes](https://arxiv.org/abs/2305.16037)<br>:star:[code](https://github.com/ibrahimethemhamamci/GenerateCT)
...
* [CTRLorALTer: Conditional LoRAdapter for Efficient 0-Shot Control & Altering of T2I Models](https://arxiv.org/abs/2405.07913)<br>:house:[project](https://compvis.github.io/LoRAdapter/)
* [EMO: Emote Portrait Alive - Generating Expressive Portrait Videos with Audio2Video Diffusion Model under Weak Conditions](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11028.pdf)
* [Inf-DiT: Upsampling any-resolution image with memory-efficient diffusion transformer](https://arxiv.org/abs/2405.04312)<br>:star:[code](https://github.com/THUDM/Inf-DiT)
* [The Lottery Ticket Hypothesis in Denoising: Towards Semantic-Driven Initialization](https://arxiv.org/abs/2312.08872)<br>:house:[project](https://ut-mao.github.io/noise.github.io)
* [MONTAGE: Monitoring Training for Attribution of Generative Diffusion Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09513.pdf)
* [TP2O: Creative Text Pair-to-Object Generation using Balance Swap-Sampling](https://arxiv.org/abs/2310.01819)
...
* [V-Trans4Style: Visual Transition Recommendation for Video Production Style Adaptation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10354.pdf)视频制作风格适配的视觉转场推荐
* GAN
...
* 扩散
  ...
  * [Do text-free diffusion models learn discriminative visual representations](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07757.pdf)
  ...
  * [ShoeModel: Learning to Wear on the User-specified Shoes via Diffusion Model](https://arxiv.org/abs/2404.04833)
  * [HiDiffusion: Unlocking Higher-Resolution Creativity and Efficiency in Pretrained Diffusion Models](https://arxiv.org/abs/2311.17528)<br>:star:[code](https://github.com/megvii-research/HiDiffusion)
  * [Chains of Diffusion Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09056.pdf)
  * [To Generate or Not? Safety-Driven Unlearned Diffusion Models Are Still Easy To Generate Unsafe Images ... For Now](https://arxiv.org/abs/2310.11868)<br>:star:[code](https://github.com/OPTML-Group/Diffusion-MU-Attack)
  * [FontStudio: Shape-Adaptive Diffusion Model for Coherent and Consistent Font Effect Generation](https://arxiv.org/abs/2406.08392)<br>:house:[project](https://font-studio.github.io/)
...
* 图像合成
  ...
  * [EpipolarGAN: Omnidirectional Image Synthesis with Explicit Camera Control](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10237.pdf)
  ...
  * [Layered Rendering Diffusion Model for Controllable Zero-Shot Image Synthesis](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08372.pdf)
  * [Label-free Neural Semantic Image Synthesis](https://arxiv.org/abs/2407.01790)
...
* 图像生成
  ...
  * [Context Diffusion: In-Context Aware Image Generation](https://arxiv.org/abs/2312.03584)<br>:house:[project](https://ivonajdenkoska.github.io/contextdiffusion/main.html)
  * [Few-shot Defect Image Generation based on Consistency Modeling](https://arxiv.org/abs/2408.00372)<br>:star:[code](https://github.com/FFDD-diffusion/DefectDiffu)
  ...
  * [Tuning-Free Image Customization with Image and Text Guidance](https://arxiv.org/abs/2403.12658)<br>:house:[project](https://zrealli.github.io/TIGIC)
  ...
  * [Accelerating Image Generation with Sub-path Linear Approximation Model](https://arxiv.org/abs/2404.13903)<br>:star:[code](https://github.com/MCG-NJU/SPLAM)
* 视频生成
  ...
  * [HARIVO: Harnessing Text-to-Image Models for Video Generation](https://arxiv.org/abs/2410.07763)<br>:house:[project](https://kwonminki.github.io/HARIVO)
  * [SignGen: End-to-End Sign Language Video Generation with Latent Diffusion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06988.pdf)<br>:star:[code](https://github.com/mingtiannihao/SignGen)
  ...
  * [DrivingDiffusion: Layout-Guided Multi-View Driving Scenarios Video Generation with Latent Diffusion Model](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10097.pdf)<br>:house:[project](https://drivingdiffusion.github.io)
  * [Photorealistic Video Generation with Diffusion Models](https://arxiv.org/abs/2312.06662)<br>:house:[project](https://walt-video-diffusion.github.io/)
...
* 视频编辑
  * [DragVideo: Interactive Drag-style Video Editing](https://arxiv.org/pdf/2312.02216)<br>:house:[project](https://dragvideo.github.io/)
  * [Video Editing via Factorized Diffusion Distillation](https://arxiv.org/abs/2403.09334)
  * [SAVE: Protagonist Diversification with Structure Agnostic Video Editing](https://arxiv.org/abs/2312.02503)<br>:house:[project](https://ldynx.github.io/SAVE/)
  ...
  * [Object-Centric Diffusion for Efficient Video Editing](https://arxiv.org/abs/2401.05735)<br>:house:[project](http://qualcomm-ai-research.github.io/object-centric-diffusion)
* 图像编辑
  ...
  * [Guide-and-Rescale: Self-Guidance Mechanism for Effective Tuning-Free Real Image Editing](https://arxiv.org/abs/2409.01322)<br>🤗[huggingface](https://huggingface.co/papers/2409.01322)
  * [COMPOSE: Comprehensive Portrait Shadow Editing](https://arxiv.org/abs/2408.13922)
  * [Fast Diffusion-Based Counterfactuals for Shortcut Removal and Generation](https://arxiv.org/abs/2312.14223)编辑
  ...
  * [Diffusion Models are Geometry Critics: Single Image 3D Editing Using Pre-Trained Diffusion Priors](https://arxiv.org/abs/2403.11503)<br>:house:[project](https://wangrc.site/Diff3DEdit/)
  ...
  * [Free-Editor: Zero-shot Text-driven 3D Scene Editing](https://arxiv.org/abs/2312.13663)<br>:house:[project](https://free-editor.github.io/)
  ...
  * [TurboEdit: Real-time text-based disentangled real image editing](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10421.pdf)
  * [DGE: Direct Gaussian 3D Editing by Consistent Multi-view Editing](https://arxiv.org/abs/2404.18929)<br>:star:[code](https://github.com/silent-chen/DGE)
  ...
  * [3D-GOI: 3D GAN Omni-Inversion for Multifaceted and Multi-object Editing](https://arxiv.org/abs/2311.12050)<br>:house:[project](https://3d-goi.github.io/)
  * [Thinking Outside the BBox: Unconstrained Generative Object Compositing](https://arxiv.org/abs/2409.04559)物体合成
...
* 图像-视频
   ...
   * [PhysGen: Rigid-Body Physics-Grounded Image-to-Video Generation](https://arxiv.org/abs/2409.18964)<br>:star:[code](https://github.com/stevenlsw/physgen)
   * [ZeroI2V: Zero-Cost Adaptation of Pre-Trained Transformers from Image to Video](https://arxiv.org/abs/2310.01324)
* 文本-视频
  ...
  * [WAVE: Warping DDIM Inversion Features for Zero-shot Text-to-Video Editing](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09682.pdf)<br>:house:[project](https://ree1s.github.io/wave/)
  ...
  * [Factorizing Text-to-Video Generation by Explicit Image Conditioning](https://arxiv.org/abs/2311.10709)<br>🤗[huggingface](https://huggingface.co/papers/2311.10709)
...
* 文本-3D
  ...
  * [LATTE3D: Large-scale Amortized Text-To-Enhanced3D Synthesis](https://arxiv.org/abs/2403.15385)<br>:house:[project](https://research.nvidia.com/labs/toronto-ai/LATTE3D/)
  ...
  * [DreamReward: Aligning Human Preference in Text-to-3D Generation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08897.pdf)<br>:house:[project](https://jamesyjl.github.io/DreamReward/)
  ...
  * [VividDreamer: Invariant Score Distillation for Hyper-Realistic Text-to-3D Generation](https://arxiv.org/abs/2407.09822)
  * [DreamScene: 3D Gaussian-based Text-to-3D Scene Generation via Formation Pattern Sampling](https://arxiv.org/abs/2404.03575)<br>:star:[code](https://github.com/DreamScene-Project/DreamScene)
  * [HiFi-123: Towards High-fidelity One Image to 3D Content Generation](https://arxiv.org/abs/2310.06744)<br>:house:[project](https://drexubery.github.io/HiFi-123/)
...
* 文本-图像
  ...
  * [MobileDiffusion: Instant Text-to-Image Generation on Mobile Devices](https://arxiv.org/abs/2311.16567)
  ...
  * [PEA-Diffusion: Parameter-Efficient Adapter with Knowledge Distillation in non-English Text-to-Image Generation](https://arxiv.org/abs/2311.17086)<br>:star:[code](https://github.com/OPPO-Mente-Lab/PEA-Diffusion)
  ...
  * [ControlNet-XS: Rethinking the Control of Text-to-Image Diffusion Models as Feedback-Control Systems](https://arxiv.org/abs/2312.06573)
  * [Skews in the Phenomenon Space Hinder Generalization in Text-to-Image Generation](https://arxiv.org/abs/2403.16394)<br>:star:[code](https://github.com/zdxdsw/skewed_relations_T2I)
  * [Enhancing Semantic Fidelity in Text-to-Image Synthesis: Attention Regulation in Diffusion Models](https://arxiv.org/abs/2403.06381)<br>:star:[code](https://github.com/YaNgZhAnG-V5/attention_regulation)
  * [Post-training Quantization with Progressive Calibration and Activation Relaxing for Text-to-Image Diffusion Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07353.pdf)
  ...
  * [Deep Reward Supervisions for Tuning Text-to-Image Diffusion Models](https://arxiv.org/abs/2405.00760)
  * [R.A.C.E.: Robust Adversarial Concept Erasure for Secure Text-to-Image Diffusion Model](https://arxiv.org/abs/2405.16341)<br>:star:[code](https://github.com/chkimmmmm/R.A.C.E)
  ...
  * [ReCON: Training-Free Acceleration for Text-to-Image Synthesis with Retrieval of Concept Prompt Trajectories](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07666.pdf)<br>:house:[project](https://stevencylu.github.io/ReCon)
  ...
  * [Unveiling and Mitigating Memorization in Text-to-image Diffusion Models through Cross Attention](https://arxiv.org/abs/2403.11052)<br>:star:[code](https://github.com/renjie3/MemAttn)
  ...
  * [MasterWeaver: Taming Editability and Face Identity for Personalized Text-to-Image Generation](https://arxiv.org/abs/2405.05806)<br>:star:[code](https://github.com/csyxwei/MasterWeaver)
  ...
  * [CogView3: Finer and Faster Text-to-Image Generation via Relay Diffusion](https://arxiv.org/abs/2403.05121)<br>:star:[code](https://github.com/THUDM/CogView3)
  ...
  * [TIBET: Identifying and Evaluating Biases in Text-to-Image Generative Models](https://arxiv.org/abs/2312.01261)<br>:house:[project](https://tibet-ai.github.io/)
  * [An Empirical Study and Analysis of Text-to-Image Generation Using Large Language Model-Powered Textual Representation](https://arxiv.org/abs/2405.12914)
  * [Adversarial Robustification via Text-to-Image Diffusion Models](https://arxiv.org/abs/2407.18658)<br>:star:[code](https://github.com/ChoiDae1/robustify-T2I)
  ...
  * [Lost in Translation: Latent Concept Misalignment in Text-to-Image Diffusion Models](https://arxiv.org/abs/2408.00230)<br>:house:[project](https://lcmis.github.io/)
  * [Text-to-Sticker: Style Tailoring Latent Diffusion Models for Human Expression](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08828.pdf)
* 图像-文本
...
* 图像-文本对齐
  ...
  * [TTD: Text-Tag Self-Distillation Enhancing Image-Text Alignment in CLIP to Alleviate Single Tag Bias](https://arxiv.org/abs/2404.00384)<br>:star:[code](https://github.com/shjo-april/TTD)
* 图像-文本
...
* 图像翻译
  * [Tackling Structural Hallucination in Image Translation with Local Diffusion](https://arxiv.org/abs/2404.05980)<br>:star:[code](https://github.com/edshkim98/LocalDiffusion-Hallucination)
* Text-to-4D
...
* 图像风格化
  ...
  * [InstaStyle: Inversion Noise of a Stylized Image is Secretly a Style Adviser](https://arxiv.org/abs/2311.15040)<br>:star:[code](https://github.com/cuixing100876/InstaStyle)风格化
  * [StyleCity: Large-Scale 3D Urban Scenes Stylization](https://arxiv.org/abs/2404.10681)<br>:house:[project](https://www.chenyingshu.com/stylecity3d/)城市场景风格化
  * [Scene-Conditional 3D Object Stylization and Composition](https://arxiv.org/abs/2312.12419)
* 图像矢量化
...
* 图像动画
  ...
  * [Champ: Controllable and Consistent Human Image Animation with 3D Parametric Guidance](https://arxiv.org/abs/2403.14781)<br>:star:[code](https://github.com/fudan-generative-vision/champ)人体图像动画
  * [TCAN: Animating Human Images with Temporally Consistent Pose Guidance using Diffusion Models](https://arxiv.org/abs/2407.09012)<br>:house:[project](https://eccv2024tcan.github.io/)
* 集体照合成
...
* 图像裁剪
  * [Mitigating Perspective Distortion-induced Shape Ambiguity in Image Crops](https://arxiv.org/abs/2312.06594)<br>:house:[project](https://ap229997.github.io/projects/ambiguity/)
...
* [Unleashing Text-to-Image Diffusion Prior for Zero-Shot Image Captioning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07445.pdf)<br>:house:[project](https://jianjieluo.github.io/SynthImgCap/)
* [HiFi-Score: Fine-grained Image Description Evaluation with Hierarchical Parsing Graphs](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07957.pdf)细粒度图像描述
* 视频字幕
  * [HowToCaption: Prompting LLMs to Transform Video Annotations at Scale](https://arxiv.org/abs/2310.04900)<br>:star:[code](https://github.com/ninatu/howtocaption)
* 密集字幕
...
* [SAH-SCI: Self-Supervised Adapter for Efficient Hyperspectral Snapshot Compressive Imaging](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08105.pdf)
...
* [Image Compression for Machine and Human Vision With Spatial-Frequency Adaptation](https://arxiv.org/abs/2407.09853)<br>:star:[code](https://github.com/qingshi9974/ECCV2024-AdpatICMH)
* [Learned HDR Image Compression for Perceptually Optimal Storage and Display](https://arxiv.org/abs/2407.13179)<br>:star:[code](https://github.com/cpb68/EPIC-HDR/)
* [WeConvene: Learned Image Compression with Wavelet-Domain Convolution and Entropy Model](https://arxiv.org/abs/2407.09983)
* [Lossy Image Compression with Foundation Diffusion Models](https://arxiv.org/abs/2404.08580)
* [A Unified Image Compression Method for Human Perception and Multiple Vision Tasks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09009.pdf)
* 视频压缩
  ...
  * [Long-term Temporal Context Gathering for Neural Video Compression](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08346.pdf)
  * [Learned Rate Control for Frame-Level Adaptive Neural Video Compression via Dynamic Neural Network](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11394.pdf)
* 视频解码  
  * [Enhancing Cross-Subject fMRI-to-Video Decoding with Global-Local Functional Alignment](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11062.pdf)视频解码
* 快照光谱成像
  * [Efficient Snapshot Spectral Imaging: Calibration-Free Parallel Structure with Aperture Diffraction Fusion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06750.pdf)
* 运动估计
  * [Leveraging scale- and orientation-covariant features for planar motion estimation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07149.pdf)<br>:star:[code](https://github.com/EricssonResearch/eccv-2024)视频预测编码-运动估计
...
* [Semi-supervised Segmentation of Histopathology Images with Noise-Aware Topological Consistency](https://arxiv.org/abs/2311.16447)<br>:star:[code](https://github.com/Melon-Xu/TopoSemiSeg)
* [CoPT: Unsupervised Domain Adaptive Segmentation using Domain-Agnostic Text Embeddings](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07950.pdf)<br>:star:[code](https://github.com/cfmata/CoPT)
...
* 抠图
  ...
  * [Diffusion for Natural Image Matting](https://arxiv.org/abs/2312.05915)<br>:star:[code](https://github.com/YihanHu-2022/DiffMatte)
...
* 3D分割
  ...
  * [View-Consistent Hierarchical 3D Segmentation Using Ultrametric Feature Fields](https://arxiv.org/abs/2405.19678)<br>:star:[code](https://github.com/hardyho/ultrametric_feature_fields)
* 视频分割
...
* 实例分割
  ...
  * 3D实例分割
    ...
    * [SAM-guided Graph Cut for 3D Instance Segmentation](https://arxiv.org/abs/2312.08372)<br>:star:[code](https://github.com/zju3dv/SAM-Graph)<br>:house:[project](https://zju3dv.github.io/sam_graph/)
    * [Continual Learning and Unknown Object Discovery in 3D Scenes via Self-Distillation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09349.pdf)<br>:star:[code](github.com/aminebdj/OpenDistill3D)实例分割
    * [OpenIns3D: Snap and Lookup for 3D Open-vocabulary Instance Segmentation](https://arxiv.org/abs/2309.00616)<br>:star:[code](https://github.com/Pointcept/OpenIns3D)
  * 无监督实例分割
...
* 语义分割
  ...
  * [Weakly Supervised Co-training with Swapping Assignments for Semantic Segmentation](https://arxiv.org/abs/2402.17891)<br>:star:[code](https://github.com/youshyee/CoSA)
  * [Context-Guided Spatial Feature Reconstruction for Efficient Semantic Segmentation](https://arxiv.org/abs/2405.06228)<br>:star:[code](https://github.com/nizhenliang/CGRSeg)
  * [On-the-fly Category Discovery for LiDAR Semantic Segmentation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06676.pdf)<br>:star:[code](https://github.com/hskim617/OCDSS)
  ...
  * [MeshSegmenter: Zero-Shot Mesh Segmentation via Texture Synthesis](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09881.pdf)<br>:star:[code](https://github.com/zimingzhong/MeshSegmenter)
  * [Towards Reliable Evaluation and Fast Training of Robust Semantic Segmentation Models](https://arxiv.org/abs/2306.12941)<br>:star:[code](https://github.com/nmndeep/robust-segmentation)
  ...
  * [Open-Vocabulary RGB-Thermal Semantic Segmentation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09460.pdf)<br>:star:[code](https://github.com/SXDR/OpenRSS)
  ...
  * 跨域语义分割
    * [Cross-Domain Semantic Segmentation on Inconsistent Taxonomy using VLMs](https://arxiv.org/abs/2408.02261)<br>:star:[code](https://github.com/jkee58/CSI)
  ...
  * 无监督语义分割
    * [Progressive Proxy Anchor Propagation for Unsupervised Semantic Segmentation](http://arxiv.org/abs/2407.12463v1)<br>:star:[code](https://github.com/hynnsk/PPAP)
  * 半监督语义分割
    * [Beyond Pixels: Semi-Supervised Semantic Segmentation with a Multi-scale Patch-based Multi-Label Classifier](http://arxiv.org/abs/2407.04036v1)<br>:star:[code](https://github.com/cvlab-stonybrook/Beyond-Pixels)
    * [Weighting Pseudo-Labels via High-Activation Feature Index Similarity and Object Detection for Semi-Supervised Segmentation](http://arxiv.org/abs/2407.12630v1)<br>:star:[code](https://github.com/cvlab-stonybrook/Weighting-Pseudo-Labels)
  ...
  * 弱监督语义分割
    ...
    * [DHR: Dual Features-Driven Hierarchical Rebalancing in Inter- and Intra-Class Regions for Weakly-Supervised Semantic Segmentation](https://arxiv.org/abs/2404.00380)<br>:star:[code](https://github.com/shjo-april/DHR)
    * [3D Weakly Supervised Semantic Segmentation with 2D Vision-Language Guidance](https://arxiv.org/abs/2407.09826)<br>:star:[code](https://github.com/xuxiaoxxxx/3DSS-VLG/)
    * [Diffusion-Guided Weakly Supervised Semantic Segmentation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06482.pdf)<br>:star:[code](https://github.com/yoon307/DiG)
  * 域适应语义分割
  ...
  * 零样本语义分割
    ...
    * [OTSeg: Multi-prompt Sinkhorn Attention for Zero-Shot Semantic Segmentation](https://arxiv.org/abs/2403.14183)<br>:house:[project](https://cubeyoung.github.io/OTSeg_project/)
  * 开放词汇语义分割
...
* 部分分割
  ...
  * [PARIS3D: Reasoning-based 3D Part Segmentation Using Large Multimodal Model](https://arxiv.org/abs/2404.03836)<br>:star:[code](https://github.com/AmrinKareem/PARIS3D)
* 运动分割
...
* 线段分割
  * [LineFit: A Geometric Approach for Fitting Line Segments in Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07181.pdf)
* 场景解析
...
* 伪装目标分割
  * [Open-Vocabulary Camouflaged Object Segmentation](https://arxiv.org/abs/2311.11241)<br>:star:[code](https://github.com/lartpang/OVCamo)
* 参考图像分割
...
* 指代图像分割
  ...
  * [GTMS: A Gradient-driven Tree-guided Mask-free Referring Image Segmentation Method](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08341.pdf)<br>:star:[code](https://github.com/eternalld/GTMS)
  * [Finding NeMo: Negative-mined Mosaic Augmentation for Referring Image Segmentation](https://arxiv.org/abs/2411.01494)<br>:house:[project](https://dddonghwa.github.io/NeMo/)
* 场景文本分割
...
* [Labeled Data Selection for Category Discovery](https://arxiv.org/abs/2406.04898)
* [Active Generation for Image Classification](https://arxiv.org/abs/2403.06517)<br>:star:[code](https://github.com/hunto/ActGen)
...
* [An accurate detection is not all you need to combat label noise in web-noisy datasets](http://arxiv.org/abs/2407.05528v1)<br>:star:[code](https://github.com/PaulAlbert31/LSA)
...
* [Discovering Unwritten Visual Classifiers with Large Language Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08086.pdf)
* 广义类别发现
  ...
  * [Textual Knowledge Matters: Cross-Modality Co-Teaching for Generalized Visual Class Discovery](https://arxiv.org/abs/2403.07369)<br>:star:[code](https://github.com/HaiyangZheng/TextGCD)广义类别发现(Generalized Category Discovery,GCD)
  * [Learning to Distinguish Samples for Generalized Category Discovery](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08177.pdf)<br>:star:[code](https://github.com/FlyingRoastDuck/NGCNCVCS.git)
  ...
  * [Online Continuous Generalized Category Discovery](https://arxiv.org/abs/2408.13492)<br>:star:[code](https://github.com/KHU-AGI/OCGCD)广义类别发现
...
* 小样本分类
  ...
  * [Semantic-guided Robustness Tuning for Few-Shot Transfer Across Extreme Domain Shift](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06583.pdf)小样本分类
* 零样本分类
...
* 长尾识别
  ...
  * [Echoes of the Past: Boosting Long-tail Recognition via Reflective Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08380.pdf)<br>:star:[code](https://github.com/fistyee/LTRL)
* 细粒度
...
* [UniProcessor: A Text-induced Unified Low-level Image Processor](https://www.arxiv.org/abs/2407.20928)
* 恢复
  ...
  * [Panel-Specific Degradation Representation for Raw Under-Display Camera Image Restoration](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06479.pdf)<br>:star:[code](https://github.com/OBAKSA/DREUDC)
  ...
  * [A Comparative Study of Image Restoration Networks for General Backbone Network Design](https://arxiv.org/abs/2310.11881)
  ...
  * [Osmosis: RGBD Diffusion Prior for Underwater Image Restoration](https://arxiv.org/abs/2403.14837)<br>:house:[project](https://osmosis-diffusion.github.io/)
  * [Contribution-based Low-Rank Adaptation with Pre-training Model for Real Image Restoration](https://arxiv.org/abs/2408.01099)<br>:house:[project](https://janeyeon.github.io/colora/)
  * [DiffBIR: Toward Blind Image Restoration with Generative Diffusion Prior](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07690.pdf)<br>:star:[code](https://github.com/XPixelGroup/DiffBIR)
  * [MetaWeather: Few-Shot Weather-Degraded Image Restoration](https://arxiv.org/abs/2308.14334)<br>:star:[code](https://github.com/RangeWING/MetaWeather)
  * [Depth-Aware Blind Image Decomposition for Real-World Adverse Weather Recovery](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10835.pdf)
* 修补
...
* 去噪
  ...
  * [Region-Aware Sequence-to-Sequence Learning for Hyperspectral Denoising](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07745.pdf)<br>:star:[code](https://github.com/MIV-XJTU/RAS2S)
  * [DualDn: Dual-domain Denoising via Differentiable ISP](https://arxiv.org/abs/2409.18783)<br>:star:[code](https://github.com/OpenImagingLab/DualDn)
  ...
  * [Switch Diffusion Transformer: Synergizing Denoising Tasks with Sparse Mixture-of-Experts](https://arxiv.org/abs/2403.09176)<br>:house:[project](https://byeongjun-park.github.io/Switch-DiT/)
  * [Enhancing Plausibility Evaluation for Generated Designs with Denoising Autoencoder](https://arxiv.org/abs/2403.05352)<br>:star:[code](https://github.com/jiajie96/FDD_pytorch)
* 去雾
  ...
  * [Prompt-Based Test-Time Real Image Dehazing: A Novel Pipeline](https://arxiv.org/abs/2309.17389)<br>:star:[code](https://github.com/cecret3350/PTTD-Dehazing)
* 去模糊
...
* 去卷积
  ...
  * [Kernel Diffusion: An Alternate Approach to Blind Deconvolution](https://arxiv.org/abs/2312.02319)
* 去反射
  ...
  * [Flash-Splat: 3D Reflection Removal with Flash Cues and Gaussian Splats](https://arxiv.org/abs/2410.02764)<br>:house:[project](https://flash-splat.github.io/)消除 3D 反射
* 去伪影
...
* 目标移除
  ...
  * [ObjectDrop: Bootstrapping Counterfactuals for Photorealistic Object Removal and Insertion](https://arxiv.org/abs/2403.18818)<br>🤗[huggingface](https://huggingface.co/papers/2403.18818)
* 扩图
...
* 图像修饰
  * [Taming Lookup Tables for Efficient Image Retouching](https://arxiv.org/abs/2403.19238)<br>:star:[code](https://github.com/Stephen0808/ICELUT)
* 图像增强
  ...
  * [LMT-GP: Combined Latent Mean-Teacher and Gaussian Process for Semi-supervised Low-light Image Enhancement](https://arxiv.org/abs/2408.16235)<br>:star:[code](https://github.com/hfut-cv/lmt-gp)
  * [RAVE: Residual Vector Embedding for CLIP-Guided Backlit Image Enhancement](https://arxiv.org/abs/2404.01889)<br>:star:[code](https://github.com/Atmyre/RAVE)
  * [Image-adaptive 3D Lookup Tables for Real-time Image Enhancement with Bilateral Grids](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06517.pdf)<br>:star:[code](https://github.com/WontaeaeKim/LUTwithBGrid)
...
* 图像质量评估
  ...
  * [DSMix: Distortion-Induced Saliency Map Based Pre-training for No-Reference Image Quality Assessment](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08824.pdf)<br>:star:[code](https://github.com/I2-Multimedia-Lab/DSMix)
* 图像美学质量评价
...
* 视频去雨
  * [Dual-Rain: Video Rain Removal using Assertive and Gentle Teachers](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08521.pdf)
* 视频去噪
  * [Temporal As a Plugin: Unsupervised Video Denoising with Pre-Trained Image Denoisers](https://arxiv.org/abs/2409.11256)<br>:star:[code](https://github.com/zfu006/TAP)
* 视频去雪
...
* 视频去模糊
  ...
  * [CMTA: Cross-Modal Temporal Alignment for Event-guided Video Deblurring](https://arxiv.org/abs/2408.14930)<br>:star:[code](https://github.com/intelpro/CMTA)
...
* 视频去马赛克
  * [Self-Supervised Video Desmoking for Laparoscopic Surgery](https://arxiv.org/abs/2403.11192)<br>:star:[code](https://github.com/ZcsrenlongZ/SelfSVD)  
* 视频质量增强
...
* 重照明
  ...
  * [The Sky's the Limit: Relightable Outdoor Scenes via a Sky-pixel Constrained Illumination Prior and Outside-In Visibility](https://arxiv.org/abs/2311.16937)<br>:star:[code](https://github.com/JADGardner/neusky)重照明
...
* [SMFANet: A Lightweight Self-Modulation Feature Aggregation Network for Efficient Image Super-Resolution](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06713.pdf)<br>:star:[code](https://github.com/Zheng-MJ/SMFANet)
* [Towards Robust Full Low-bit Quantization of Super Resolution Networks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09567.pdf)
...
* [Confidence-Based Iterative Generation for Real-World Image Super-Resolution](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08254.pdf)<br>:star:[code](https://github.com/USTC-JialunPeng/RealSRT)
...
* [Learning Dual-Level Deformable Implicit Representation for Real-World Scale Arbitrary Super-Resolution](https://arxiv.org/abs/2403.10925)<br>:star:[code](https://github.com/nonozhizhiovo/RealArbiSR)
...
* [Crowd-SAM:SAM as a smart annotator for object detection in crowded scenes](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08766.pdf)<br>:star:[code](https://github.com/FelixCaae/CrowdSAM)
* [Distilling Knowledge from Large-Scale Image Models for Object Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11200.pdf)
* [DeTra: A Unified Model for Object Detection and Trajectory Forecasting](https://arxiv.org/abs/2406.04426)
* [Modality Translation for Object Detection Adaptation without forgetting prior knowledge](https://arxiv.org/abs/2404.01492)
* [OpenSight: A Simple Open-Vocabulary Framework for LiDAR-Based Object Detection](https://arxiv.org/abs/2312.08876)
...
* [Out-of-Bounding-Box Triggers: A Stealthy Approach to Cheat Object Detectors](https://arxiv.org/abs/2410.10091)<br>:star:[code](https://github.com/linToTao/Out-of-bbox-attack)
* [A Simple Background Augmentation Method for Object Detection with Diffusion Model](https://arxiv.org/abs/2408.00350)
* [Look Around and Learn: Self-Training Object Detection by Exploration](https://arxiv.org/abs/2302.03566)<br>:star:[code](https://github.com/IIT-PAVIS/Look_Around_And_Learn)
* [Co-Student: Collaborating Strong and Weak Students for Sparsely Annotated Object Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06407.pdf)<br>:star:[code](https://github.com/hustvl/CoStudent)
...
* [Rethinking Features-Fused-Pyramid-Neck for Object Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08386.pdf)<br>:star:[code](https://github.com/AlanLi1997/rethinking-fpn)
* 3D目标检测
  ...
  * [Domain Generalization of 3D Object Detection by Density-Resampling](https://arxiv.org/abs/2311.10845)<br>:star:[code](https://github.com/xingyu-group/3D-Density-Resampling-SDG)
  ...
  * [LiDAR-based All-weather 3D Object Detection via Prompting and Distilling 4D Radar](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07349.pdf)
  * [Towards Stable 3D Object Detection](https://arxiv.org/abs/2407.04305)
  * [RecurrentBEV: A Long-term Temporal Fusion Framework for Multi-view 3D Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09090.pdf)<br>:star:[code](https://github.com/lucifer443/RecurrentBEV)
  * [LISO: Lidar-only Self-Supervised 3D Object Detection](https://arxiv.org/abs/2403.07071)<br>:star:[code](https://github.com/baurst/liso)
  * [Diffusion Model for Robust Multi-Sensor Fusion in 3D Object Detection and BEV Segmentation](https://arxiv.org/abs/2404.04629)<br>:star:[code](https://github.com/ldtho/DifFUSER)
  * [SAMFusion: Sensor-Adaptive Multimodal Fusion for 3D Object Detection in Adverse Weather](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07882.pdf)
  * [Unlocking Textual and Visual Wisdom: Open-Vocabulary 3D Object Detection Enhanced by Comprehensive Guidance from Text and Image](https://arxiv.org/abs/2407.05256)
  ...
  * [CMD: A Cross Mechanism Domain Adaptation Dataset for 3D Object Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07443.pdf)<br>:star:[code](https://github.com/im-djh/CMD)<br>:thumbsup:[DIG从密度、强度和几何三方面缓和传感器体制带来的点云数据差异，显著提升了域自适应算法的性能。](https://std.xmu.edu.cn/2024/0710/c4739a488273/page.htm)
...
* 小目标检测
  ...
  * [DQ-DETR: DETR with Dynamic Query for Tiny Object Detection](https://arxiv.org/abs/2404.03507)<br>:star:[code](https://github.com/hoiliu-0801/DQ-DETR)
...
* 伪装目标检测
  ...
  * [FocusDiffuser: Perceiving Local Disparities for Camouflaged Object Detection](https://arxiv.org/abs/2407.13133)<br>:star:[code](https://github.com/JWZhao-uestc/FocusDiffuser)
* 长尾目标检测
...
* 共同显著目标检测
  * [CONDA: Condensed Deep Association Learning for Co-Salient Object Detection](http://arxiv.org/abs/2409.01021v1)<br>:star:[code](https://github.com/dragonlee258079/CONDA)
...
* 开放词汇目标检测
  ...
  * [Region-centric Image-Language Pretraining for Open-Vocabulary Detection](https://arxiv.org/abs/2310.00161)<br>:star:[code](https://github.com/google-research/google-research/tree/master/fvlm/dito)
  * [CLIFF: Continual Latent Diffusion for Open-Vocabulary Object Detection](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07221.pdf)<br>:star:[code](https://github.com/CUHK-AIM-Group/CLIFF)
* 水印检测
...
* 阴影检测
  ...
  * [Two-Stage Video Shadow Detection via Temporal-Spatial Adaption](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06444.pdf)<br>:house:[project](https://hizuka590.github.io/CVSD)
* 开集识别
...
* 目标定位
  ...
  * [Pro2SAM: Mask Prompt to SAM with Grid Points for Weakly Supervised Object Localization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08795.pdf)
...
* [CoTracker: It is Better to Track Together](https://arxiv.org/abs/2307.07635)<br>:house:[project](https://co-tracker.github.io/)
...
* 多目标跟踪
  ...
  * [PapMOT: Exploring Adversarial Patch Attack against Multiple Object Tracking](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06758.pdf)
  * [VETRA: A Dataset for Vehicle Tracking in Aerial Imagery - New Challenges for Multi-Object Tracking](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11352.pdf)<br>:house:[project](https://www.dlr.de/en/eoc/vetra)
* 细胞跟踪  
  * [Trackastra: Transformer-based cell tracking for live-cell microscopy](https://arxiv.org/abs/2405.15700)<br>:star:[code](https://github.com/weigertlab/trackastra)
  * [Large-Scale Multi-Hypotheses Cell Tracking Using Ultrametric Contours Maps](https://arxiv.org/abs/2308.04526)<br>:star:[code](https://github.com/royerlab/ultrack)
...
* 文档理解
  * [Textual Grounding for Open-vocabulary Visual Information Extraction in Layout-diversified Documents](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06219.pdf)<br>:thumbsup:[结合版式感知上下文学习和适用于文档的两阶段预训练，显著提高了模型对文档的理解能力](https://std.xmu.edu.cn/2024/0710/c4739a488273/page.htm)
...
* 文本分割
  * [WAS: Dataset and Methods for Artistic Text Segmentation](http://arxiv.org/abs/2408.00106v1)<br>:star:[code](https://github.com/xdxie/WASWordArt-Segmentation)
* 文本合成
  * [Visual Text Generation in the Wild](https://arxiv.org/abs/2407.14138)<br>:star:[code](https://github.com/AlibabaResearch/AdvancedLiterateMachinery/tree/main/OCR/SceneVTG)
* 文本修复
  * [LLMCO4MR: LLMs-aided Neural Combinatorial Optimization for Ancient Manuscript Restoration from Fragments with Case Studies on Dunhuang](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09585.pdf)从碎片修复古代手稿以敦煌为例

<a name="4"/>

## 4.Pose(姿态估计)
* [X-Pose: Detecting Any Keypoints](https://arxiv.org/abs/2310.08530)<br>:star:[code](https://github.com/IDEA-Research/X-Pose)
* [VQ-HPS: Human Pose and Shape Estimation in a Vector-Quantized Latent Space](https://arxiv.org/abs/2312.08291)<br>:house:[project](https://g-fiche.github.io/research-pages/vqhps/)
...
* [Within the Dynamic Context: Inertia-aware 3D Human Modeling with Pose Sequence](https://arxiv.org/abs/2403.19160)
...
* [Human Pose Recognition via Occlusion-Preserving Abstract Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10791.pdf)
* 文本驱动的人体生成
  * [InterFusion: Text-Driven Generation of 3D Human-Object Interaction](https://arxiv.org/abs/2403.15612)<br>:house:[project](https://sisidai.github.io/InterFusion/)
  * [Towards Open Domain Text-Driven Synthesis of Multi-Person Motions](https://arxiv.org/abs/2405.18483)<br>:house:[project](https://shanmy.github.io/Multi-Motion/)
* 多人姿势预测
...
* 3D人体姿态估计
  ...
  * [AvatarPose: Avatar-guided 3D Pose Estimation of Close Human Interaction from Sparse Multi-view Videos](https://arxiv.org/abs/2408.02110)<br>:star:[code](https://github.com/eth-ait/AvatarPose)<br>:house:[project](https://eth-ait.github.io/AvatarPose/)
  ...
  * [RT-Pose: A 4D Radar-Tensor based 3D Human Pose Estimation and Localization Benchmark](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07989.pdf)<br>🤗[huggingface](https://huggingface.co/datasets/uwipl/RT-Pose)
  * [EgoPoseFormer: A Simple Baseline for Stereo Egocentric 3D Human Pose Estimation](https://arxiv.org/abs/2403.18080)<br>:star:[code](https://github.com/chenhongyiyang/egoposeformer)
  ...
  * [NICP: Neural ICP for 3D Human Registration at Scale](https://arxiv.org/abs/2312.14024)<br>:house:[project](https://neural-icp.github.io/)
* 人体网格恢复
  ...
  * [WindPoly: Polygonal Mesh Reconstruction via Winding Numbers](https://arxiv.org/abs/2407.19208)<br>:house:[project](https://vcc.tech/research/2024/WindPoly)
  * [Multi-RoI Human Mesh Recovery with Camera Consistency and Contrastive Losses](https://arxiv.org/abs/2402.02074)<br>:star:[code](https://github.com/CptDiaos/Multi-RoI)
* 3D人体纹理生成
...
* 3D人体生成
  ...
  * [Text Motion Translator: A Bi-Directional Model for Enhanced 3D Human Motion Generation from Open-Vocabulary Descriptions](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08050.pdf)
...
* 手语识别
  ...
  * [A Simple Baseline for Spoken Language to Sign Language Translation with 3D Avatars](https://arxiv.org/abs/2401.04730)<br>:star:[code](https://github.com/FangyunWei/SLRT)
* 手部网格
  * [HandDGP: Camera-Space Hand Mesh Prediction with Differentiable Global Positioning](http://arxiv.org/abs/2407.15844v1)
* 3D手部序列恢复
  * [3D Hand Sequence Recovery from Real Blurry Images and Event Stream](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07674.pdf)
* 3D手部重建
  ...
  * [MLPHand: Real Time Multi-View 3D Hand Reconstruction via MLP Modeling](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09503.pdf)<br>:star:[code](https://github.com/jackyyang9/MLPHand)
* 手部姿态估计
  ...
  * [3D Hand Pose Estimation in Everyday Egocentric Images](https://arxiv.org/abs/2312.06583)
* 手部运动预测
...
* 手语视频生成
  ...
  * [Co-speech Gesture Video Generation with 3D Human Meshes](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12483.pdf)
...
* [GAMMA-FACE: GAussian Mixture Models Amend Diffusion Models for Bias Mitigation in Face Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08466.pdf)
* [GRAPE: Generalizable and Robust Multi-view Facial Capture](https://arxiv.org/abs/2407.10193)
* [High-Quality Mesh Blendshape Generation from Face Videos via Neural Inverse Rendering](https://arxiv.org/abs/2401.08398)<br>:star:[code](https://github.com/grignarder/high-quality-blendshape-generation)
* 人脸交换
  * [SelfSwapper: Self-Supervised Face Swapping via Shape Agnostic Masked AutoEncoder](https://arxiv.org/abs/2402.07370)<br>🤗[huggingface](https://huggingface.co/papers/2402.07370)
* 人脸模糊
...
* 人脸识别
  * [Towards Certifiably Robust Face Recognition](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11379.pdf)
  * [AdaDistill: Adaptive Knowledge Distillation for Deep Face Recognition](https://arxiv.org/abs/2407.01332)<br>:star:[code](https://github.com/fdbtrs/AdaDistill)
  ...
  * [dversariaLeak: External Information Leakage Attack Using Adversarial Samples on Face Recognition Systems](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09603.pdf)
* 人脸聚类
  * [VideoClusterNet: Self-Supervised and Adaptive Face Clustering for Videos](https://arxiv.org/abs/2407.12214)人脸聚类
* 人脸重建
  * [Face Reconstruction Transfer Attack as Out-of-Distribution Generalization](http://arxiv.org/abs/2407.02403v1)<br>:star:[code](https://github.com/jungyg/ALSUV.git)
* 人脸表情
...
* 人脸编辑
  ...
  * [Real-time 3D-aware Portrait Editing from a Single Image](https://arxiv.org/abs/2402.14000)<br>:star:[code](https://github.com/EzioBy/3dpe)肖像编辑
  * [Efficient 3D-Aware Facial Image Editing via Attribute-Specific Prompt Learning](https://arxiv.org/abs/2406.04413)<br>:star:[code](https://github.com/VIROBO-15/Efficient-3D-Aware-Facial-Image-Editing)
* 人脸动画
  ...
  * [Fast Registration of Photorealistic Avatars for VR Facial Animation](https://arxiv.org/abs/2401.11002)<br>:house:[project](https://chaitanya100100.github.io/FastRegistration/)
...
* 说话头合成
  ...
  * [All You Need is Your Voice: Emotional Face Representation with Audio Perspective for Emotional Talking Face Generation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08116.pdf)<br>:star:[code](https://github.com/sbde500/EAP)
...
* 人脸活体检测
  ...
  * [DiffFAS: Face Anti-Spoofing via Generative Diffusion Models](https://arxiv.org/abs/2409.08572)<br>:star:[code](https://github.com/murphytju/DiffFAS)
  ...
  * [Bottom-Up Domain Prompt Tuning for Generalized Face Anti-Spoofing](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08866.pdf)
* 头部合成  
  ...
  * [Loc3Diff: Local Diffusion for 3D Human Head Synthesis and Editing](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08166.pdf)
* 情绪识别
...
* 人脸动作单元检测
  * [AUFormer: Vision Transformers are Parameter-Efficient Facial Action Unit Detectors](https://arxiv.org/abs/2403.04697)<br>:star:[code](https://github.com/yuankaishen2001/AUFormer)
* 假脸检测
...
* [HSR: Holistic 3D Human-Scene Reconstruction from Monocular Videos](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09167.pdf)<br>:house:[project](https://lxxue.github.io/human-scene-recon/)
...
* [Single-Photon 3D Imaging with Equi-Depth Photon Histograms](https://arxiv.org/abs/2408.16150)<br>:house:[project](https://www.computational.camera/pedh)
* [Viewpoint textual inversion: discovering scene representations and 3D view control in 2D diffusion models](https://arxiv.org/abs/2309.07986)<br>:star:[code](https://github.com/jmhb0/view_neti)
...
* [BAGS: Blur Agnostic Gaussian Splatting through Multi-Scale Kernel Modeling](https://arxiv.org/abs/2403.04926)<br>:star:[code](https://github.com/snldmt/BAGS)
* [Soft Shadow Diffusion (SSD): Physics-inspired Learning for 3D Computational Periscopy](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10427.pdf)
...
* [MinD-3D: Reconstruct High-quality 3D objects in Human Brain](https://arxiv.org/abs/2312.07485)<br>:house:[project](https://jianxgao.github.io/MinD-3D/)3D
* [UpFusion: Novel View Diffusion from Unposed Sparse View Observations](https://arxiv.org/abs/2312.06661)<br>:star:[code](https://github.com/upfusion3d/upfusion)3D
* MVS 
  * [Smoothness, Synthesis, and Sampling: Re-thinking Unsupervised Multi-View Stereo with DIV Loss](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08045.pdf)<br>:star:[code](https://github.com/alexrich021/div-loss)
* 3D Visual Grounding
  ...
  * [Four Ways to Improve Verbo-visual Fusion for Dense 3D Visual Grounding](https://arxiv.org/abs/2309.04561)<br>:house:[project](http://ouenal.github.io/concretenet/)
* Stereo Matching
...
* 3DGS
  ...
  * [End-to-End Rate-Distortion Optimized 3D Gaussian Representation](https://arxiv.org/abs/2406.01597)
  * [Deblurring 3D Gaussian Splatting](https://arxiv.org/abs/2401.00834)<br>:star:[code](https://github.com/benhenryL/Deblurring-3D-Gaussian-Splatting)<br>:house:[project](https://benhenryl.github.io/Deblurring-3D-Gaussian-Splatting/)
  ...
  * [Street Gaussians: Modeling Dynamic Urban Scenes with Gaussian Splatting](https://arxiv.org/abs/2401.01339)<br>:star:[code](https://github.com/zju3dv/street_gaussians)
  * [DGD: Dynamic 3D Gaussians Distillation](https://arxiv.org/abs/2405.19321)<br>:house:[project](https://isaaclabe.github.io/DGD-Website/)
  * [EAGLES: Efficient Accelerated 3D Gaussians with Lightweight EncodingS](https://arxiv.org/abs/2312.04564)<br>:star:[code](https://github.com/Sharath-girish/efficientgaussian)
  * [Revising Densification in Gaussian Splatting](https://arxiv.org/abs/2404.06109)
  * [HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes](https://arxiv.org/abs/2403.20032)
  ...
  * [VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors](https://arxiv.org/abs/2407.02945)<br>:star:[code](https://github.com/deepshwang/vegs)
  ...
  * [GGRt: Towards Generalizable 3D Gaussians without Pose Priors in Real-Time](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09006.pdf)<br>:house:[project](https://3d-aigc.github.io/GGRt)
  * [Gaussian in the wild: 3D Gaussian Splatting for Unconstrained Image Collections](https://arxiv.org/abs/2403.15704)<br>:star:[code](https://github.com/EastbeanZhang/Gaussian-Wild)
  ...
  * [DynMF: Neural Motion Factorization for Real-time Dynamic View Synthesis with 3D Gaussian Splatting](https://arxiv.org/abs/2312.00112)<br>:star:[code](https://github.com/agelosk/dynmf)
* 深度估计
  ...
  * [PatchRefiner: Leveraging Synthetic Data for Real-Domain High-Resolution Monocular Metric Depth Estimation](https://arxiv.org/abs/2406.06679)<br>:star:[code](https://github.com/zhyever/PatchRefiner)
  * [Remove Projective LiDAR Depthmap Artifacts via Exploiting Epipolar Geometry](https://arxiv.org/abs/2407.19154)深度图伪影
  * [Revisit Self-supervision with Local Structure-from-Motion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10690.pdf)
  * [DoubleTake: Geometry Guided Depth Estimation](https://arxiv.org/abs/2406.18387)<br>:star:[code](https://github.com/nianticlabs/doubletake)
  * [Physics-informed Knowledge Transfer for Underwater Monocular Depth Estimation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09034.pdf)
  ...
  * [GroCo: Ground Constraint for Metric Self-Supervised Monocular Depth](https://arxiv.org/abs/2409.14850)<br>:star:[code](https://github.com/Visual-Behavior/GroCo)深度估计
...
* 深度补全
  ...
  * [AugUndo: Scaling Up Augmentations for Monocular Depth Completion and Estimation](https://arxiv.org/abs/2310.09739)<br>:star:[code](https://github.com/alexklwong/augundo)
  * [Sparse Beats Dense: Rethinking Supervision in Radar-Camera Depth Completion](https://arxiv.org/abs/2312.00844)<br>:star:[code](https://github.com/megvii-research/Sparse-Beats-Dense)
* 表面重建
  ...
  * [GS2Mesh: Surface Reconstruction from Gaussian Splatting via Novel Stereo Views](https://arxiv.org/abs/2404.01810)<br>:house:[project](https://gs2mesh.github.io/)
  * [Improving Neural Surface Reconstruction with Feature Priors from Multi-View Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07603.pdf)<br>:star:[code](https://github.com/maybeLx/MVS_NeuS)
...
* 三维重建
  ...
  * [latentSplat: Autoencoding Variational Gaussians for Fast Generalizable 3D Reconstruction](https://arxiv.org/abs/2403.16292)<br>:star:[code](https://github.com/Chrixtar/latentsplat)
  * [MirrorGaussian: Reflecting 3D Gaussians for Reconstructing Mirror Reflections](https://arxiv.org/abs/2405.11921)<br>:house:[project](https://mirror-gaussian.github.io/)
  * [Resolving Scale Ambiguity in Multi-view 3D Reconstruction using Dual-Pixel Sensors](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06658.pdf)<br>:star:[code](https://github.com/kohei-ashida/dp-sfm)
  * [3D Reconstruction of Objects in Hands without Real World 3D Supervision](https://arxiv.org/abs/2305.03036)
  ...
  * [SUP-NeRF: A Streamlined Unification of Pose Estimation and NeRF for Monocular 3D Object Reconstruction](https://arxiv.org/abs/2403.15705)<br>:star:[code](https://github.com/abhi1kumar/SUP-NeRF)
  ...
  * [Sketch2Vox: Learning 3D Reconstruction from a Single Monocular Sketch Image](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09384.pdf)<br>:sunflower:[dataset](https://drive.google.com/file/d/1aXug8PcLnWaDZiWZrcmhvVNFC4n_eAih/view?usp=sharing)
...
* 三维形状
  ...
  * [TetraDiffusion: Tetrahedral Diffusion Models for 3D Shape Generation](https://arxiv.org/abs/2211.13220)<br>:star:[code](https://github.com/PeterTor/TetraDiffusion)<br>:house:[project](https://tetradiffusion.github.io/)
  * [Learning Neural Deformation Representation for 4D Dynamic Shape Generation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09107.pdf)
  * [AWOL: Analysis WithOut synthesis using Language](https://arxiv.org/abs/2404.03042)3D shape
  * [DiscoMatch: Fast Discrete Optimisation for Geometrically Consistent 3D Shape Matching](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07026.pdf)
* 视频重建
...
* 3D 纹理形状
  ...
  * [Learning Pseudo 3D Guidance for View-consistent Texturing with 2D Diffusion](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11528.pdf)文本驱动的 3D 纹理
...
* [Situated Instruction Following](https://arxiv.org/abs/2407.12061)<br>:house:[project](https://soyeonm.github.io/SIF_webpage/)<br>:house:[project](https://soyeonm.github.io/SIF_webpage/)
...
* [SphereHead: Stable 3D Full-head Synthesis with Spherical Tri-plane Representation](https://arxiv.org/abs/2404.05680)<br>:house:[project](https://lhyfst.github.io/spherehead)
* [VisionLLaMA: A Unified LLaMA Backbone for Vision Tasks](https://arxiv.org/abs/2403.00522)<br>:star:[code](https://github.com/Meituan-AutoML/VisionLLaMA)
* [Global Counterfactual Directions](https://arxiv.org/abs/2404.12488)
* [Which Model Generated This Image? A Model-Agnostic Approach for Origin Attribution](https://arxiv.org/abs/2404.02697)
* [Computing the Lipschitz constant needed for fast scene recovery from CASSI measurements](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07936.pdf)
* [Pseudo-Labelling Should Be Aware of Disguising Channel Activations](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08036.pdf)
* [FMBoost: Boosting Latent Diffusion with Flow Matching](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07855.pdf)<br>:star:[code](https://github.com/CompVis/fm-boosting)
* [Holodepth: Programmable Depth-Varying Projection via Computer-Generated Holography](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07832.pdf)<br>:house:[project](https://github.com/dorianchan/holodepth)
* [Adversarial Diffusion Distillation](https://arxiv.org/abs/2311.17042)
* [When and How do negative prompts take effect](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12484.pdf)
...
* [Unsupervised Representation Learning by Balanced Self Attention Matching](https://arxiv.org/abs/2408.02014)<br>:star:[code](https://github.com/danielshalam/bam)
* [DualBEV: Unifying Dual View Transformation with Probabilistic Correspondences](https://arxiv.org/abs/2403.05402)<br>:star:[code](https://github.com/PeidongLi/DualBEV)
* [Linking in Style: Understanding learned features in deep learning models](https://arxiv.org/abs/2409.16865)<br>:star:[code](https://github.com/kaschube-lab/LinkingInStyle.git)
* [CliffPhys: Camera-based Respiratory Measurement using Clifford Neural Networks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11393.pdf)
* [Synthesizing Environment-Specific People in Photographs](https://arxiv.org/abs/2312.14579)<br>:house:[project](https://esp.is.tue.mpg.de/)
* [Implicit Steganography Beyond the Constraints of Modality](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11671.pdf)
* [Energy-Clibrated VAE with Test Time Free Lunch](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11433.pdf)
* [Debiasing surgeon: fantastic weights and how to find them](https://arxiv.org/abs/2403.14200)
* [SparseRadNet: Sparse Perception Neural Network on Subsampled Radar Data](https://arxiv.org/abs/2406.10600)
...
* [Using My Artistic Style? You Must Obtain My Authorization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11672.pdf)<br>:star:[code](https://github.com/CherishL-J/ASPS)
* [IFTR: An Instance-Level Fusion Transformer for Visual Collaborative Perception](https://arxiv.org/abs/2407.09857)<br>:star:[code](https://github.com/wangsh0111/IFTR)
* [Convex Relaxations for Manifold-Valued Markov Random Fields with Approximation Guarantees](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11823.pdf)
* [Adapting to Shifting Correlations with Unlabeled Data Calibration](https://arxiv.org/abs/2409.05996)
* [On Spectral Properties of Gradient-based Explanation Methods](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11865.pdf)
* [O2V-Mapping: Online Open-Vocabulary Mapping with Neural Implicit Representation](https://arxiv.org/abs/2404.06836)
* [A Framework for Efficient Model Evaluation through Stratification, Sampling, and Estimation](https://arxiv.org/abs/2406.07320)
* [Non-Line-of-Sight Estimation of Fast Human Motion with Slow Scanning Imagers](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12133.pdf)
* [Image Manipulation Detection With Implicit Neural Representation and Limited Supervision](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/12164.pdf)
* [Adaptive Bounding Box Uncertainties via Two-Step Conformal Prediction](https://arxiv.org/abs/2403.07263)
* [GOEmbed: Gradient Origin Embeddings for Representation Agnostic 3D Feature Learning](https://arxiv.org/abs/2312.08744)<br>:house:[project](https://holodiffusion.github.io/goembed/)
* [AddBiomechanics Dataset: Capturing the Physics of Human Motion at Scale](https://arxiv.org/abs/2406.18537)<br>:house:[project](https://addbiomechanics.org/download_data.html)
* [Tight and Efficient Upper Bound on Spectral Norm of Convolutional Layers](https://arxiv.org/abs/2409.11859)
...
* [Learning to Build by Building Your Own Instructions](https://www.arxiv.org/abs/2410.01111)<br>:star:[code](github.com/aaronwalsman/ltron-torch/tree/eccv-24)
* [LNL+K: Enhancing Learning with Noisy Labels Through Noise Source Knowledge Integration](https://arxiv.org/abs/2306.11911)<br>:star:[code](https://github.com/SunnySiqi/LNL_K)
* [Deep Online Probability Aggregation Clustering](https://arxiv.org/abs/2407.05246)
* [Camera Calibration using a Collimator System](https://arxiv.org/abs/2409.20034)<br>:star:[code](https://github.com/LiangSK98/CollimatorCalibration)
* [Asynchronous Bioplausible Neuron for Spiking Neural Networks for Event-Based Vision](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08133.pdf)
* [LITA: Language Instructed Temporal-Localization Assistant](https://arxiv.org/abs/2403.19046)<br>:star:[code](https://github.com/NVlabs/LITA)
* [INTRA: Interaction Relationship-aware Weakly Supervised Affordance Grounding](https://arxiv.org/abs/2409.06210)<br>:house:[project](https://jeeit17.github.io/INTRA)
* [Elucidating the Hierarchical Nature of Behavior with Masked Autoencoders](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08076.pdf)<br>:star:[code](https://github.com/amathislab/BehaveMAE)
* [MetaAT: Active Testing for Label-Efficient Evaluation of Dense Recognition Tasks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10062.pdf)
* [Generalizable Symbolic Optimizer Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10485.pdf)<br>:star:[code](https://github.com/songxt3/SOL)
* [Training A Secure Model against Data-Free Model Extraction](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10236.pdf)
* [EraseDraw : Learning to Insert Objects by Erasing Them from Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10156.pdf)
* [AdaDiff: Accelerating Diffusion Models through Step-Wise Adaptive Computation](https://arxiv.org/abs/2309.17074)
* [Imaging with Confidence: Uncertainty Quantification for High-dimensional Undersampled MR Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10086.pdf)<br>:star:[code](https://github.com/HannahLaus/Project_UQ_TV.git)
* [Learning to Make Keypoints Sub-Pixel Accurate](https://arxiv.org/abs/2407.11668)<br>:star:[code](https://github.com/KimSinjeong/keypt2subpx)
* [Explorative Inbetweening of Time and Space](https://arxiv.org/abs/2403.14611)<br>:house:[project](https://time-reversal.github.io/)
* [Salience-Based Adaptive Masking: Revisiting Token Dynamics for Enhanced Pre-training](https://arxiv.org/abs/2404.08327)<br>:star:[code](https://github.com/doihye/SBAM)
* [Instant Uncertainty Calibration of NeRFs Using a Meta-Calibrator](https://arxiv.org/abs/2312.02350)<br>:star:[code](https://github.com/niki-amini-naieni/instantcalibration)
* [Improving Robustness to Model Inversion Attacks via Sparse Coding Architectures](https://arxiv.org/abs/2403.14772)
* [Constructing Concept-based Models to Mitigate Spurious Correlations with Minimal Human Effort](https://arxiv.org/abs/2407.08947)
* [Neural Poisson Solver: A Universal and Continuous Framework for Natural Signal Blending](https://arxiv.org/abs/2407.08457)
* [Augmented Neural Fine-tuning for Efficient Backdoor Purification](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10431.pdf)
* [REDIR: Refocus-free Event-based De-occlusion Image Reconstruction](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10433.pdf)
* [Comprehensive Attribution: Inherently Explainable Vision Model with Feature Detector](https://arxiv.org/abs/2407.19308)<br>:star:[code](https://github.com/Zood123/COMET)
* [Pre-trained Visual Dynamics Representations for Efficient Policy Learning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10552.pdf)
* [MMEarth: Exploring Multi-Modal Pretext Tasks For Geospatial Representation Learning](https://arxiv.org/abs/2405.02771)<br>:house:[project](https://vishalned.github.io/mmearth/)
* [MARs: Multi-view Attention Regularizations for Patch-based Feature Recognition of Space Terrain](https://arxiv.org/abs/2410.05182)<br>:house:[project](https://droneslab.github.io/mars/)
* [Diff-Reg: Diffusion Model in Doubly Stochastic Matrix Space for Registration Problem](https://arxiv.org/pdf/2403.19919)<br>:star:[code](https://github.com/wuqianliang/Diff-Reg)
* [Hetecooper: Feature Collaboration Graph for Heterogeneous Collaborative Perception](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07071.pdf)
* [FARSE-CNN: Fully Asynchronous, Recurrent and Sparse Event-Based CNN](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07037.pdf)<br>:star:[code](https://github.com/AIRLab-POLIMI/farse-cnn)
* [Unmasking Bias in Diffusion Model Training](https://arxiv.org/abs/2310.08442)<br>:star:[code](https://github.com/yuhuUSTC/Debias)
* [Cross-Input Certified Training for Universal Perturbations](https://arxiv.org/abs/2405.09176)
* [Investigating Style Similarity in Diffusion Models](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08294.pdf)
* [Delving into Adversarial Robustness on Document Tampering Localization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08224.pdf)<br>:star:[code](https://github.com/SHR-77/DTL-ARob.git)
* [AMD: Automatic Multi-step Distillation of Large-scale Vision Models](https://arxiv.org/abs/2407.04208)
* [Learning Scalable Model Soup on a Single GPU: An Efficient Subspace Training Strategy](https://arxiv.org/abs/2407.03641)<br>:star:[code](https://github.com/nblt/MEHL-Soup)
* [JDT3D: Addressing the Gaps in LiDAR-Based Tracking-by-Attention](https://arxiv.org/abs/2407.04926)<br>:star:[code](https://github.com/TRAILab/JDT3D)
* [SPARO: Selective Attention for Robust and Compositional Transformer Encodings for Vision](https://arxiv.org/abs/2404.15721)
* [Adaptive Annealing for Robust Averaging](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08834.pdf)
* [Lost in Translation: Modern Neural Networks Still Struggle With Small Realistic Image Transformations](https://arxiv.org/abs/2404.07153)
* [Generalizing to Unseen Domains via Text-guided Augmentation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08759.pdf)
* [MO-EMT-NAS: Multi-Objective Continuous Transfer of Architectural Knowledge Between Tasks from Different Datasets](https://arxiv.org/abs/2407.13122)
* [Learning a Dynamic Privacy-preserving Camera Robust to Inversion Attacks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08911.pdf)
* [MaxMI: A Maximal Mutual Information Criterion for Manipulation Concept Discovery](https://arxiv.org/abs/2407.15086)
* [CadVLM: Bridging Language and Vision in the Generation of Parametric CAD Sketches](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08913.pdf)
* [Towards Image Ambient Lighting Normalization](https://arxiv.org/abs/2403.18730)
* [Synthesizing Time-varying BRDFs via Latent Space](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08964.pdf)
* [HoloADMM: High-Quality Holographic Complex Field Recovery](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08965.pdf)
* [Fundamental Matrix Estimation Using Relative Depths](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08966.pdf)
* [MTaDCS: Moving Trace and Feature Density-based Confidence Sample Selection under Label Noise](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08968.pdf)<br>:star:[code](https://github.com/QZ-CODER/-ECCV-24-MTaD")
* [CipherDM: Secure Three-Party Inference for Diffusion Model Sampling](https://www.arxiv.org/abs/2409.05414)<br>:star:[code](https://github.com/Zhaoxinxinzi/CipherDM)
* [Weighted Ensemble Models Are Strong Continual Learners](https://arxiv.org/abs/2312.08977)<br>:star:[code](https://github.com/IemProg/CoFiMA)
* [Learning Equilibrium Transformation for Gamut Expansion and Color Restoration](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09030.pdf)<br>:star:[code](https://github.com/junxiao01/LETNet)
* [Implicit Neural Models to Extract Heart Rate from Video](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10941.pdf)<br>:house:[project](https://implicitppg.github.io/)
* [Learning Quantized Adaptive Conditions for Diffusion Models](https://arxiv.org/abs/2409.17487)
* [High-Fidelity Modeling of Generalizable Wrinkle Deformation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10650.pdf)
* [Efficient Learning of Event-based Dense Representation using Hierarchical Memories with Adaptive Update](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10733.pdf)
* [SlimFlow: Training Smaller One-Step Diffusion Models with Rectified Flow](https://arxiv.org/abs/2407.12718)<br>:star:[code](https://github.com/yuanzhi-zhu/SlimFlow)
* [DreamSampler: Unifying Diffusion Sampling and Score Distillation for Image Manipulation](https://arxiv.org/abs/2403.11415)<br>:star:[code](https://github.com/DreamSampler/dream-sampler)
* [PosterLlama: Bridging Design Ability of Langauge Model to Content-Aware Layout Generation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10849.pdf)
* [Integration of Global and Local Representations for Fine-grained Cross-modal Alignment](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10886.pdf)
* [Veil Privacy on Visual Data: Concealing Privacy for Humans, Unveiling for DNNs](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/11044.pdf)
* [A high-quality robust diffusion framework for corrupted dataset](https://arxiv.org/abs/2311.17101)<br>:star:[code](https://github.com/VinAIResearch/RDUOT)
* [FRDiff : Feature Reuse for Universal Training-free Acceleration of Diffusion Models](https://arxiv.org/abs/2312.03517)<br>:star:[code](https://github.com/ECoLab-POSTECH/FRDiff)
* [Leveraging Imperfect Restoration for Data Availability Attack](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09216.pdf)<br>:star:[code](https://github.com/lyumingzhi/IRP)
* [Oulu Remote-photoplethysmography Physical Domain Attacks Database (ORPDAD)](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09215.pdf)<br>:star:[code](https://github.com/marukosan93/ORPDAD/)
* [Spiking Wavelet Transformer](https://arxiv.org/abs/2403.11138)<br>:star:[code](https://github.com/bic-L/Spiking-Wavelet-Transformer)
* [Hypernetworks for Generalizable BRDF Representation](https://arxiv.org/abs/2311.15783)<br>:house:[project](https://faziletgokbudak.github.io/HyperBRDF/)
* [Solving the inverse problem of microscopy deconvolution with a residual Beylkin-Coifman-Rokhlin neural network](https://arxiv.org/abs/2407.03239)
* [Photon Inhibition for Energy-Efficient Single-Photon Imaging](https://arxiv.org/abs/2409.18337)<br>:house:[project](https://wisionlab.com/project/inhibition)
* [RANRAC: Robust Neural Scene Representations via Random Ray Consensus](https://arxiv.org/abs/2312.09780)<br>:house:[project](https://bennobuschmann.com/ranrac/)
* [Characterizing Model Robustness via Natural Input Gradients](https://arxiv.org/abs/2409.20139)
* [Emerging Property of Masked Token for Effective Pre-training](https://arxiv.org/abs/2404.08330)
* [SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians](https://arxiv.org/abs/2403.10427)
* [Curved Diffusion: A Generative Model With Optical Geometry Control](https://arxiv.org/abs/2311.17609)<br>:house:[project](https://anylens-diffusion.github.io/)
* [Mini-Splatting: Representing Scenes with a Constrained Number of Gaussians](https://arxiv.org/abs/2403.14166)<br>:star:[code](https://github.com/fatPeter/mini-splatting)
* [Skeleton Recall Loss for Connectivity Conserving and Resource Efficient Segmentation of Thin Tubular Structures](https://arxiv.org/abs/2404.03010)<br>:star:[code](https://github.com/MIC-DKFZ/Skeleton-Recall)
...
* [Optimization-based Uncertainty Attribution Via Learning Informative Perturbations](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/10054.pdf)
* [CPT-VR: Improving Surface Rendering via Closest Point Transform with View-Reflection Appearance](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09272.pdf)
* [Think before Placement: Common Sense Enhanced Transformer for Object Placement](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09204.pdf)
* [Efficient Bias Mitigation Without Privileged Information](https://arxiv.org/abs/2409.17691)
* [Region-Native Visual Tokenization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09359.pdf)<br>:star:[code](https://github.com/MengyuWang826/Reader)
* [DiffCD: A Symmetric Differentiable Chamfer Distance for Neural Implicit Surface Fitting](https://arxiv.org/abs/2407.17058)<br>:star:[code](https://github.com/linusnie/diffcd)
* [Efficient Neural Video Representation with Temporally Coherent Modulation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09437.pdf)
* [Made to Order: Discovering monotonic temporal changes via self-supervised video ordering](https://arxiv.org/abs/2404.16828)<br>:star:[code](https://github.com/charigyang/made2order)
* [Concise Plane Arrangements for Low-Poly Surface and Volume Modelling](https://arxiv.org/abs/2404.06154)<br>:star:[code](https://github.com/raphaelsulzer/compod)
* [ViPer: Visual Personalization of Generative Models via Individual Preference Learning](https://arxiv.org/abs/2407.17365)<br>:star:[code](https://github.com/EPFL-VILAB/ViPer)
* [How Far Can a 1-Pixel Camera Go? Solving Vision Tasks using Photoreceptors and Computationally Designed Visual Morphology](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09512.pdf)
* [Watching it in Dark: A Target-aware Representation Learning Framework for High-Level Vision Tasks in Low Illumination](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09518.pdf)<br>:star:[code](https://github.com/ZhangYh994/WiiD)
* [3R-INN: How to be climate friendly while consuming/delivering videos](https://arxiv.org/abs/2403.11760)
* [Model Breadcrumbs: Scaling Multi-Task Model Merging with Sparse Masks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09596.pdf)<br>:star:[code](https://github.com/rezazzr/breadcrumbs)
* [Dynamic Guidance Adversarial Distillation with Enhanced Teacher Knowledge](https://arxiv.org/abs/2409.01627)<br>:star:[code](https://github.com/kunsaram01/DGAD)
* [Idling Neurons, Appropriately Lenient Workload During Fine-tuning Leads to Better Generalization](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06989.pdf)
* [ConDense: Consistent 2D-3D Pre-training for Dense and Sparse Features from Multi-View Images](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07038.pdf)
* [Tokenize Anything via Prompting](https://arxiv.org/abs/2312.09128)<br>:star:[code](https://github.com/baaivision/tokenize-anything)<br>🤗[huggingface](https://huggingface.co/BAAI/tokenize-anything)
* [Efficient Diffusion-Driven Corruption Editor for Test-Time Adaptation](https://arxiv.org/abs/2403.10911)<br>:star:[code](https://github.com/oyt9306/Decorruptor)
* [Long-CLIP: Unlocking the Long-Text Capability of CLIP](https://arxiv.org/abs/2403.15378)<br>:star:[code](https://github.com/beichenzbc/Long-CLIP)
* [Dolfin: Diffusion Layout Transformers without Autoencoder](https://arxiv.org/abs/2310.16305)
* [Beyond the Contact: Discovering Comprehensive Affordance for 3D Objects from Pre-trained 2D Diffusion Models](https://arxiv.org/abs/2401.12978)<br>:star:[code](https://github.com/snuvclab/coma)
* [Hybrid Video Diffusion Models with 2D Triplane and 3D Wavelet Representation](https://arxiv.org/abs/2402.13729)<br>:star:[code](https://github.com/hxngiee/HVDM)
* [Zero-Shot Image Feature Consensus with Deep Functional Maps](https://arxiv.org/abs/2403.12038)
* [LLaVA-Plus: Learning to Use Tools for Creating Multimodal Agents](https://arxiv.org/abs/2311.05437)<br>:house:[project](https://llava-vl.github.io/llava-plus/)
* [Scissorhands: Scrub Data Influence via Connection Sensitivity in Networks](https://arxiv.org/abs/2401.06187)<br>:star:[code](https://github.com/JingWu321/Scissorhands)
* [FuseTeacher: Modality-fused Encoders are Strong Vision Supervisors](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06460.pdf)<br>:star:[code](https://github.com/Eniac-Xie/FuseTeacher)
* [SmartControl: Enhancing ControlNet for Handling Rough Visual Conditions](https://arxiv.org/abs/2404.06451)<br>:house:[project](https://smartcontrolnet.github.io/)
* [CoSIGN: Few-Step Guidance of ConSIstency Model to Solve General INverse Problems](https://arxiv.org/abs/2407.12676)<br>:star:[code](https://github.com/BioMed-AI-Lab-U-Michgan/cosign)
* [FedRA: A Random Allocation Strategy for Federated Tuning to Unleash the Power of Heterogeneous Clients](https://arxiv.org/abs/2311.11227)<br>:star:[code](https://github.com/leondada/FedRA)
...
* [Consistent 3D Line Mapping](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07710.pdf)<br>:star:[code](https://github.com/3dv-casia/clmap)
* [RSL-BA: Rolling Shutter Line Bundle Adjustment](https://arxiv.org/abs/2408.05409)
...
* [EAS-SNN: End-to-End Adaptive Sampling and Representation for Event-based Detection with Recurrent Spiking Neural Networks](https://arxiv.org/abs/2403.12574)<br>:star:[code](https://github.com/Windere/EAS-SNN)
* [PairingNet: A Learning-based Pair-searching and -matching Network for Image Fragments](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07655.pdf)
* [Distributed Active Client Selection With Noisy Clients Using Model Association Scores](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07717.pdf)
* [Towards a Density Preserving Objective Function for Learning on Point Sets](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07726.pdf)
* [Task-Driven Uncertainty Quantification in Inverse Problems via Conformal Prediction](https://arxiv.org/abs/2405.18527)<br>:star:[code](https://github.com/jwen307/TaskUQ)
...
* [Dual-Camera Smooth Zoom on Mobile Phones](https://arxiv.org/abs/2404.04908)<br>:star:[code](https://github.com/ZcsrenlongZ/ZoomGS)<br>:house:[project](https://dualcamerasmoothzoom.github.io/)
* [Learning by Aligning 2D Skeleton Sequences and Multi-Modality Fusion](https://arxiv.org/abs/2305.19480)
* [Agent Attention: On the Integration of Softmax and Linear Attention](https://arxiv.org/abs/2312.08874)<br>:star:[code](https://github.com/LeapLabTHU/Agent-Attention)
* [Deep Feature Surgery: Towards Accurate and Efficient Multi-Exit Networks](https://arxiv.org/abs/2407.13986)<br>:star:[code](https://github.com/GongCheng1919/dfs)
* [Grid-Attention: Enhancing Computational Efficiency of Large Vision Models without Fine-Tuning](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06640.pdf)<br>:star:[code](https://github.com/pengyuLPY/GridAttn)
* [Customized Generation Reimagined: Fidelity and Editability Harmonized](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/06727.pdf)<br>:star:[code](https://github.com/jinjianRick/DCIICO)
...
* [Improving Feature Stability during Upsampling -- Spectral Artifacts and the Importance of Spatial Context](https://arxiv.org/abs/2311.17524)
* [From Fake to Real: Pretraining on Balanced Synthetic Images to Prevent Spurious Correlations in Image Recognition](https://arxiv.org/abs/2308.04553)<br>:star:[code](https://github.com/mqraitem/From-Fake-to-Real)
* [Quantization-Friendly Winograd Transformations for Convolutional Neural Networks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07548.pdf)
* [LetsMap: Unsupervised Representation Learning for Label-Efficient Semantic BEV Mapping](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07537.pdf)
* [M3DBench: Towards Omni 3D Assistant with Interleaved Multi-modal Instructions](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07509.pdf)
* [Leveraging Enhanced Queries of Point Sets for Vectorized Map Construction](https://arxiv.org/abs/2402.17430)<br>:star:[code](https://github.com/HXMap/MapQR)
* [StereoGlue: Joint Feature Matching and Robust Estimation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07485.pdf)<br>:star:[code](https://github.com/danini/stereoglue)
* [Factorized Diffusion: Perceptual Illusions by Noise Decomposition](https://arxiv.org/abs/2404.11615)<br>:house:[project](https://dangeng.github.io/factorized_diffusion/)
* [GIVT: Generative Infinite-Vocabulary Transformers](https://arxiv.org/abs/2312.02116)<br>:star:[code](https://github.com/google-research/big_vision/blob/main/big_vision/configs/proj/givt/README.md)
* [Tiny Models are the Computational Saver for Large Models](https://arxiv.org/abs/2403.17726)
* [Unlocking Attributes' Contribution to Successful Camouflage: A Combined Textual and Visual Analysis Strategy](https://arxiv.org/abs/2408.12086)<br>:star:[code](https://github.com/lyu-yx/ACUMEN)
* [SNeRV: Spectra-preserving Neural Representation for Video](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07231.pdf)<br>:star:[code](https://github.com/qwertja/SNeRV)
* [COMO: Compact Mapping and Odometry](https://arxiv.org/abs/2404.03531)<br>:star:[code](https://github.com/edexheim/como)
* [Multi-Sentence Grounding for Long-term Instructional Video](https://arxiv.org/abs/2312.14055)
* [Scene Coordinate Reconstruction: Posing of Image Collections via Incremental Learning of a Relocalizer](https://arxiv.org/abs/2404.14351)<br>:house:[project](https://nianticlabs.github.io/acezero/)
* [Exact Diffusion Inversion via Bidirectional Integration Approximation](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07377.pdf)<br>:star:[code](https://github.com/guoqiang-zhang-x/BDIA)
* [McGrids: Monte Carlo-Driven Adaptive Grids for Iso-Surface Extraction](https://arxiv.org/abs/2409.06710)
* [Regulating Model Reliance on Non-Robust Features by Smoothing Input Marginal Density](https://arxiv.org/abs/2407.04370)<br>:star:[code](https://github.com/ypeiyu/input_density_reg)
* [Dynamic Data Selection for Efficient SSL via Coarse-to-Fine Refinement](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/07587.pdf)
...
* [Edge-Guided Fusion and Motion Augmentation for Event-Image Stereo](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/09268.pdf)
...
* [Teach CLIP to Develop a Number Sense for Ordinal Regression](https://arxiv.org/abs/2408.03574)<br>:star:[code](https://github.com/xmed-lab/NumCLIP)
...
* [Encapsulating Knowledge in One Prompt](https://arxiv.org/abs/2407.11902)<br>:star:[code](https://github.com/LiQiiiii/Encapsulating-Knowledge-In-One-Prompt)
...
* [Retargeting Visual Data with Deformation Fields](https://arxiv.org/abs/2311.13297)
* [Delving Deep into Engagement Prediction of Short Videos](https://arxiv.org/abs/2410.00289)<br>:star:[code](https://github.com/dasongli1/SnapUGC_Engagement)
* [Temporal-Mapping Photography for Event Cameras](https://arxiv.org/abs/2403.06443)<br>:star:[code](https://github.com/YuHanBaozju/EvTemMap)
* [Six-Point Method for Multi-Camera Systems with Reduced Solution Space](https://arxiv.org/abs/2402.18066)<br>:star:[code](https://github.com/jizhaox/relpose-6pt)
* [BK-SDM: A Lightweight, Fast, and Cheap Version of Stable Diffusion](https://arxiv.org/abs/2305.15798)<br>:star:[code](https://github.com/Nota-NetsPresso/BK-SDM)
...
* [EventBind: Learning a Unified Representation to Bind Them All for Event-based Open-world Understanding](https://arxiv.org/abs/2308.03135)<br>:star:[code](https://github.com/jiazhou-garland/EventBind)
...
* [Similarity of Neural Architectures using Adversarial Attack Transferability](https://arxiv.org/abs/2210.11407)
* [NeuroPictor: Refining fMRI-to-Image Reconstruction via Multi-individual Pretraining and Multi-level Modulation](https://arxiv.org/abs/2403.18211)<br>:house:[project](https://jingyanghuo.github.io/neuropictor/)
* [Robustness Preserving Fine-tuning using Neuron Importance](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08486.pdf)
* [A Riemannian Approach for Spatiotemporal Analysis and Generation of 4D Tree-shaped Structures](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08440.pdf)
* [Dual-Path Adversarial Lifting for Domain Shift Correction in Online Test-time Adaptation](https://arxiv.org/abs/2408.13983)<br>:star:[code](https://github.com/yushuntang/DPAL)
...
* [UL-VIO: Ultra-lightweight Visual-Inertial Odometry with Noise Robust Test-time Adaptation](https://arxiv.org/abs/2409.13106)视觉惯性里程计
...
* [SPVLoc: Semantic Panoramic Viewport Matching for 6D Camera Localization in Unseen Environments](https://arxiv.org/abs/2404.10527)<br>:star:[code](https://github.com/fraunhoferhhi/spvloc)
...
* [Dataset Distillation by Automatic Training Trajectories](http://arxiv.org/abs/2407.14245v1)<br>:star:[code](https://github.com/NiaLiu/ATT)
...
* [SelfGeo: Self-supervised and Geodesic-consistent Estimation of Keypoints on Deformable Shapes](https://arxiv.org/abs/2408.02291)<br>:star:[code](https://github.com/IIT-PAVIS/SelfGeo)
* [Explain via Any Concept: Concept Bottleneck Model with Open Vocabulary Concepts](https://arxiv.org/abs/2408.02265)
* [Motion and Structure from Event-based Normal Flow](http://arxiv.org/abs/2407.12239v1)<br>:house:[project](https://nail-hnu.github.io/EvLinearSolver/)
...
* [Möbius Transform for Mitigating Perspective Distortions in Representation Learning](https://arxiv.org/abs/2405.02296)<br>:house:[project](https://prakashchhipa.github.io/projects/mpd)
...
* [Learning to Complement and to Defer to Multiple Users](http://arxiv.org/abs/2407.07003v1)<br>:star:[code](https://github.com/zhengzhang37/LECODU.git)
...
* [HyperSpaceX: Radial and Angular Exploration of HyperSpherical Dimensions](https://www.arxiv.org/abs/2408.02494)
...
* [SceneScript: Reconstructing Scenes With An Autoregressive Structured Language Model](https://arxiv.org/abs/2403.13064)<br>:house:[project](https://projectaria.com/scenescript)
...
* [A Diffusion Model for Simulation Ready Coronary Anatomy with Morpho-skeletal Control](http://arxiv.org/abs/2407.15631v1)<br>:star:[code](https://github.com/kkadry/Morphoskel-Diffusion)
